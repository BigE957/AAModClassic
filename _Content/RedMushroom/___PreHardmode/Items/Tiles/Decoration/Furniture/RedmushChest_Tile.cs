...
{
    public class RedmushChest_Tile : ModTile
    {
        public override void SetStaticDefaults()
        {
			...
			AddMapEntry(new Color(200, 150, 20), name, MapChestName);

			RegisterItemDrop(ModContent.ItemType<RedmushChest>(), 0);
        }
		...
		public override void MouseOver(int i, int j)
        {
			...
			if (chest < 0) {
				...
				if (player.cursorItemIconText == defaultName) {
					player.cursorItemIconID = ModContent.ItemType<RedmushChest>();
