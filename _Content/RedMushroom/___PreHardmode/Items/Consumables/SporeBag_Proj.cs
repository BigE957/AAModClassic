...
{
    public class SporeBag_Proj : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Spore Sac");
        }
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("AAModClassic/Projectiles/Flasks/SporeSac").Value;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            int radius = 6;
            int FlaskDust = ModContent.DustType<Dusts.MushDust>();
            ...
            for (int x = -radius; x <= radius; x++)
            {
                for (int y = -radius; y <= radius; y++)
                {
                    ...
                    {
                        WorldGen.Convert(xPosition, yPosition, ModContent.GetInstance<MushroomConversion>().Type, 1, true, true);
                    }
                }
            }
        }
