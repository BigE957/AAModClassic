...
{
    public class SubzeroSerpent_Tail : BiomeConvertableNPC
    {
        public override string Texture => "AAModClassic/_Content/Snow/___PreHardmode/NPCs/__BossSubzeroSerpent/BossTextures/Default/SubzeroSerpent_Tail";
