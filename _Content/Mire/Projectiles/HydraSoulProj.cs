...
namespace AAModClassic._Content.Mire.Projectiles
{
    public class HydraSoulProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int num557 = 8;
            //dust!
            int dustId = Dust.NewDust(new Vector2(Projectile.position.X + num557, Projectile.position.Y + num557), Projectile.width - num557 * 2, Projectile.height - num557 * 2, ModContent.DustType<Dusts.YamataADust>(), 0f, 0f, 0);
            Main.dust[dustId].noGravity = true;
            int dustId3 = Dust.NewDust(new Vector2(Projectile.position.X + num557, Projectile.position.Y + num557), Projectile.width - num557 * 2, Projectile.height - num557 * 2, ModContent.DustType<Dusts.YamataADust>(), 0f, 0f, 0);
