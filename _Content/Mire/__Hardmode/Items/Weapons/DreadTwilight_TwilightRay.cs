...
{
    public class DreadTwilight_TwilightRay : ModProjectile
    {
		...
		public override void AI()
		{
            if (Main.rand.NextFloat() < 1f)
            {
                ...
                dust = Main.dust[Dust.NewDust(position, 30, 30, DustID.WaterCandle, 0f, 0f, 60, new Color(0, 255, 92), 1.381579f)];
                dust.noGravity = true;
