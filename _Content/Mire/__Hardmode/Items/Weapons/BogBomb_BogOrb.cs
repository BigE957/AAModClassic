...
namespace AAModClassic._Content.Mire.__Hardmode.Items.Weapons
{
    ...
    public class BogBomb_BogOrb : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X, Projectile.Center.Y, (float)(Main.rand.Next(171) - 85) / 100, (float)(Main.rand.Next(176) - 900) / 100, ModContent.ProjectileType<BogBomb_BogDrop>(), Projectile.damage, 2f, Projectile.owner,0f,0f);
                }
            }
        }
