...
namespace AAModClassic._Content.Mire.__Hardmode.Items.Tiles.Decoration
{
	public class BogtoxinTorch : BaseAAItem, ILocalizedModType
    {
		...
		public override void HoldItem(Player player)
		{
			...
			Lighting.AddLight(position, AAColor.BogToxin.R / 255f, AAColor.BogToxin.G / 255f, AAColor.BogToxin.B / 255f);
		}
		...
		public override void PostUpdate()
		{
			if (!Item.wet)
			{
				Lighting.AddLight((int)((Item.position.X + Item.width / 2) / 16f), (int)((Item.position.Y + Item.height / 2) / 16f), AAColor.BogToxin.R / 255f, AAColor.BogToxin.G / 255f, AAColor.BogToxin.B / 255f);
			}
		}
