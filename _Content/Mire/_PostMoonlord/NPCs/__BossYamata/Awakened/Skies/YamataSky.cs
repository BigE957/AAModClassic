...
namespace AAModClassic._Content.Mire._PostMoonlord.NPCs.__BossYamata.Awakened.Skies
{
    ...
    public class YamataSky : CustomSky
    {
        ...
        {
            MoonTex = ModContent.Request<Texture2D>("AAModClassic/_Content/Mire/_PostMoonlord/NPCs/__BossYamata/Awakened/Skies/YamataSky_Moon");
            BeamTex = ModContent.Request<Texture2D>("AAModClassic/_Content/Mire/_PostMoonlord/NPCs/__BossYamata/Awakened/Skies/YamataSky_Beam");
            for (int i = 0; i < RockTex.Length; i++)
            {
                RockTex[i] = ModContent.Request<Texture2D>("AAModClassic/_Content/Mire/_PostMoonlord/NPCs/__BossYamata/Awakened/Skies/YamataSky_Rock" + i);
            }
            SkyTex = ModContent.Request<Texture2D>("AAModClassic/_Content/Mire/_PostMoonlord/NPCs/__BossYamata/Awakened/Skies/YamataSky_Sky");
        }
