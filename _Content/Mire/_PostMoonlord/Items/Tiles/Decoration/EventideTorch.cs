...
{
	public class EventideTorch : BaseAAItem, ILocalizedModType
    {
        ...
        public override void HoldItem(Player player)
		{
			...
			Lighting.AddLight(position, AAColor.YamataA.R / 255f, AAColor.YamataA.G / 255f, AAColor.YamataA.B / 255f);
		}
		...
		public override void PostUpdate()
		{
			if (!Item.wet)
			{
				Lighting.AddLight((int)((Item.position.X + Item.width / 2) / 16f), (int)((Item.position.Y + Item.height / 2) / 16f), AAColor.YamataA.R / 255f, AAColor.YamataA.G / 255f, AAColor.YamataA.B / 255f);
			}
		}
