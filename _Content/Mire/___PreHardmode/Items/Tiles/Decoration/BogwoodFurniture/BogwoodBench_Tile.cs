...
{
    public class BogwoodBench_Tile : ModTile
	{
        public override void SetStaticDefaults()
        {
            this.SetUpSofa(ModContent.ItemType<BogwoodBench>(), false, true);
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.BenchMouseOver(i, j, ModContent.ItemType<BogwoodBench>());
