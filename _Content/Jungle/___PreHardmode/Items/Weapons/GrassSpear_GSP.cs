...
{
    /// <summary>
    /// the projs name used to be just "GSP" which is obv shorthand for Grass Spear Projectile but thats so absurd im keeping it. displayname was not altered it also was just GSP. gsp kind of sounds like bfp. can u believe lockjaw was based on tiy
    /// </summary>
    public class GrassSpear_GSP : ModProjectile
    {
