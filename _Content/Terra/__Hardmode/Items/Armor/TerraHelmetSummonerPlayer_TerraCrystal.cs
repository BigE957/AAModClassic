...
{
    public class TerraHelmetSummonerPlayer_TerraCrystal : ModProjectile
	{
        ...
        public override void AI()
		{
			...
			else
			{
                ...
                {
                    bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<TerraHelmetSummonerPlayer_TerraCrystal>();
