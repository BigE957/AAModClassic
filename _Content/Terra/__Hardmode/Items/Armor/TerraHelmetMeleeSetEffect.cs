...
{
    public class TerraHelmetMeleeSetEffect : EquipmentEffectData
    {
        public override void DoEffect(Player player)
        {
            player.GetModPlayer<TerraHelmetMeleeSetPlayer>().effect = true;
        }
    }

    public class TerraHelmetMeleeSetPlayer : EquipmentEffectPlayer
    {
