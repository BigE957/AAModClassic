...
{
    public class TerraStaff_TerraWizard : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (dust >= 0)
            {
                ...
                {
                    int num503 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y + 16f), Projectile.width, Projectile.height - 16, DustID.Terra, 0f, 0f, 0);
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<TerraStaff_TerraWizard>();
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                int num658 = ModContent.ProjectileType<TerraStaff_MagicBlast>();
