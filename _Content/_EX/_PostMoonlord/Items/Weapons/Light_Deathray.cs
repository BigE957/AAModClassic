...
{
    public class Light_Deathray : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.type != ModContent.ProjectileType<Light_Deathray>() || !Main.projectile[(int)Projectile.ai[1]].active || Main.projectile[(int)Projectile.ai[1]].type != ModContent.ProjectileType<Light_Holdout>())
			{
				Projectile.Kill();
				return;
			}
