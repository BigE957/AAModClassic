...
{
    public class SupremeHellshot_Hellshot : ModProjectile
    {
            ...
            if (Projectile.alpha > 0)
            {
                ...
                if (Projectile.alpha < 0)
                {
                    ...
                    while (num110 < num109)
                    {
                        ...
                        int num111 = Dust.NewDust(Projectile.Center, 0, 0, DustID.RedTorch, 0f, 0f, 0);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int num88 = Dust.NewDust(position, num84, height3, DustID.RedTorch, 0f, 0f, 200, default, 3.7f);
                ...
                num88 = Dust.NewDust(position, num84, height3, DustID.RedTorch, 0f, 0f, 100, default, 1.5f);
                Main.dust[num88].position = Projectile.Center + Vector2.UnitY.RotatedByRandom(3.1415927410125732) * (float)Main.rand.NextDouble() * num84 / 2f;
            ...
            {
                int num90 = Dust.NewDust(position, num84, height3, DustID.RedTorch, 0f, 0f, 0, default, 2.7f);
