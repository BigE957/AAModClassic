...
namespace AAModClassic._Content._EX._PostMoonlord.Items.Weapons     //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class ScytheOfEvil_Holdout : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                if (Projectile.ai[1] > 20)
                {
                    ...
                    num22 *= num24;
                    num23 *= num24;
                    int a = Projectile.NewProjectile(Projectile.GetSource_FromThis(), vector.X, vector.Y, num22, num23, ModContent.ProjectileType<ScytheOfEvil_Proj>(), Projectile.damage, Projectile.knockBack, player.whoAmI, 0f, 0f);
        ...
        public override bool PreDraw(ref Color lightColor)  //this make the projectile sprite rotate perfectaly around the player
        {
            ...
            Main.spriteBatch.Draw(Glowmask.Value, Projectile.Center - Main.screenPosition, null, lightColor, Projectile.rotation, new Vector2(texture.Width / 2, texture.Height / 2), 1f, Projectile.spriteDirection == 1 ? SpriteEffects.None : SpriteEffects.FlipHorizontally, 0f);
            return false;
        }
