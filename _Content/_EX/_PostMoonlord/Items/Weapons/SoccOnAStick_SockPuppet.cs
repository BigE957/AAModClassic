...
{
    public class SoccOnAStick_SockPuppet : ModProjectile
    {
        ...
        {
            bool flag64 = Projectile.type == ModContent.ProjectileType<SoccOnAStick_SockPuppet>();
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<SoccOnAStick_SockPuppet>();
