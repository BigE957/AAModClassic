...
Scythe of the Grim Reaper EX"); */
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<GrimReaperScytheEX_Proj>();
			Item.shootSpeed = 16f;
			Item.value = 1000000;
		...
		{
			if (type == ModContent.ProjectileType<GrimReaperScytheEX_Proj>())
			{
				float num121 = 0.99f;
				int num122 = 3;
				...
				for (int num123 = 0; num123 < num122; num123++)
				{
					...
					if (type == ModContent.ProjectileType<GrimReaperScytheEX_Proj>() && player.HasBuff(ModContent.BuffType<ReaperImmune2_Buff>()))
					{
