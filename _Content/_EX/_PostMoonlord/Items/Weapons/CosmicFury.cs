...
{
    public class CosmicFury : BaseAAItem, ILocalizedModType
    {
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
		{
			...
			for (int num120 = 0; num120 < 3; num120++)
			{
				...
				Projectile.NewProjectile(source, vector2.X, vector2.Y, speedX5, speedY6, ModContent.ProjectileType<CosmicFury_Proj>(), damage*3/2, knockback, Main.myPlayer);
			}
			return false;
		}
