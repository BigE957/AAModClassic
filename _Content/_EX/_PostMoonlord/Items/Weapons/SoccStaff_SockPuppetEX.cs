...
{
    public class SoccStaff_SockPuppetEX : ModProjectile
    {
        ...
        {
            bool flag64 = Projectile.type == ModContent.ProjectileType<SoccStaff_SockPuppetEX>();
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<SoccStaff_SockPuppetEX>();
