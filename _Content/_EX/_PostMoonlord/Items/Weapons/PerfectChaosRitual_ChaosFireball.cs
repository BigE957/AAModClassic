...
{
    public class PerfectChaosRitual_ChaosFireball : ModProjectile
    {
        ...
        {
            int p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, ModContent.ProjectileType<PerfectChaosRitual_ChaosExplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, ModContent.ProjectileType<PerfectChaosRitual_ChaosExplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
    }
}
