...
{
    public class StarburstWand_Holdout : ModProjectile
    {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                switch (chargeLevel)
                {
					...
					case 1:
                        ...
                        Projectile.NewProjectile(Projectile.GetSource_Death(), vector2.X, vector2.Y, velocity.X, velocity.Y, ModContent.ProjectileType<StarburstWand_SparkMedium>(), (int)(Projectile.damage * 1.5), 3f, player.whoAmI);
						break;
					case 2:
						SoundEngine.PlaySound(SoundID.Item88, Projectile.position);
                        Projectile.NewProjectile(Projectile.GetSource_Death(), vector2.X, vector2.Y, velocity.X, velocity.Y, ModContent.ProjectileType<StarburstWand_SparkLarge>(), Projectile.damage * 2, 6f, player.whoAmI);
						break;
                }
            }
        }
