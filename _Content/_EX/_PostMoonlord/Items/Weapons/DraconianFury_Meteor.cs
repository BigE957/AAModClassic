...
{
    public class DraconianFury_Meteor : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, ModContent.ProjectileType<DraconianFury_Flamesplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
