    ...
    public class Chronos_Holdout : ModProjectile 
    {
        ...
        public override void PostAI()
        {
            ...
            if (Projectile.localAI[1] >= 20f)
            {
                ...
                vector *= 0.8f;
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X - vector.X, Projectile.Center.Y - vector.Y, vector.X, vector.Y, ModContent.ProjectileType<TimeTeller_Time>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 1, 0f);
