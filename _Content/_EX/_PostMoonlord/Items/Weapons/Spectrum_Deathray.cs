...
{
    public class Spectrum_Deathray : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.type != ModContent.ProjectileType<Spectrum_Deathray>() || !Main.projectile[(int)Projectile.ai[1]].active || Main.projectile[(int)Projectile.ai[1]].type != ModContent.ProjectileType<Spectrum_Holdout>())
			{
				Projectile.Kill();
				return;
			}
