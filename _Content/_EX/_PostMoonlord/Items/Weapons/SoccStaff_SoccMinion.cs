...
{
    public class SoccStaff_SoccMinion : ModProjectile
    {
        ...
        {
            bool flag64 = Projectile.type == ModContent.ProjectileType<SoccStaff_SoccMinion>();
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<SoccStaff_SoccMinion>();
