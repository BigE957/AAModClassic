    ...
    public class Apocalypse_FlamingJack : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (Main.rand.NextBool(3))
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_OnHit(target), target.position.X, target.position.Y, 0f, 0f, ModContent.ProjectileType<Apocalypse_Heal>(), 0, 0f, Projectile.owner, num2, num);
            }
        }
    }
}