...
{
    public class FreedomStar_Holdout : ModProjectile
    {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                switch (chargeLevel)
                {
                    case 0:
						...
						Projectile.NewProjectile(Projectile.GetSource_Death(), vector2.X, vector2.Y, Velocity.X, Velocity.Y, ModContent.ProjectileType<FreedomStar_FreedomShot>(), Projectile.damage, 1f, player.whoAmI);
						break;
					case 1:
						SoundEngine.PlaySound(SoundID.Item89, Projectile.position);
                        Projectile.NewProjectile(Projectile.GetSource_Death(), vector2.X, vector2.Y, Velocity.X, Velocity.Y, ModContent.ProjectileType<FreedomStar_FreedomShot>(), Projectile.damage*2, 1f, player.whoAmI);
						break;
					case 2:
					...
					case 3:
						SoundEngine.PlaySound(SoundID.Item88, Projectile.position);
                        Projectile.NewProjectile(Projectile.GetSource_Death(), vector2.X, vector2.Y, Velocity.X, Velocity.Y, ModContent.ProjectileType<FreedomStar_FreedomChargedShot>(), Projectile.damage*10, 1f, player.whoAmI);
						break;
                }
            }
        }
