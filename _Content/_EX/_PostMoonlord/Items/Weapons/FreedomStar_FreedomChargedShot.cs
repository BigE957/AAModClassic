...
{
    public class FreedomStar_FreedomChargedShot : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_OnHit(target), Projectile.Center, new Vector2(0, 0), ModContent.ProjectileType<FreedomStar_PlasmaBall>(), Projectile.damage, 0f, Projectile.owner);
                firstHit = false;
            }
        }
