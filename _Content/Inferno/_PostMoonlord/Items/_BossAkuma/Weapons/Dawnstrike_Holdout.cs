...
{
    public class Dawnstrike_Holdout : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (chargeLevel == 3)
            {
                type = ModContent.ProjectileType<Dawnstrike_BlastLarge>();
                damage = Projectile.damage * 1.5f;
            }
            else if (chargeLevel == 2)
            {
                type = ModContent.ProjectileType<Dawnstrike_BlastMedium>();
                damage = Projectile.damage * 1.3f;
            }
            else
            {
                type = ModContent.ProjectileType<Dawnstrike_BlastSmall>();
            }
        ...
        {
            Texture2D glowTex = ModContent.Request<Texture2D>("AAModClassic/Glowmasks/Dawnstrike_Glow").Value;
