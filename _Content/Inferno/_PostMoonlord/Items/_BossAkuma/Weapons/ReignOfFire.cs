...
Inflicts Daybroken"); */
		...
		public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
		{
			if (Main.rand.NextBool(10))
			{
				...
				int p = Projectile.NewProjectile(Item.GetSource_ReleaseEntity(), vector2.X, vector2.Y, speedX5, speedY6, ModContent.ProjectileType<ReignOfFire_Meteor>(), Item.damage/2, Item.knockBack, Main.myPlayer);
				switch (Main.rand.Next(5))
				{
					...
					case 1: 
					    ...
					    break;
					case 2: 
                        Main.projectile[p].ai[0] = 3f;
					    break;
					case 3: 
                        Main.projectile[p].ai[0] = 4f;
					    break;
					case 4: 
                        Main.projectile[p].ai[0] = 5f;
					    break;
				}
			}
