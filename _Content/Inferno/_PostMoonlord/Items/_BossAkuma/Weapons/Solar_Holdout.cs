...
namespace AAModClassic._Content.Inferno._PostMoonlord.Items._BossAkuma.Weapons   //The directory for your .cs and .png; Example: TutorialMOD/Projectiles
{
    public class Solar_Holdout : ModProjectile   //make sure the sprite file is named like the class name (CustomYoyoProjectile)
    {
        ...
        public override void SetStaticDefaults()
        {
            if (Main.netMode != NetmodeID.Server)
            {
                ...
                glowMasks[glowMasks.Length - 1] = ModContent.Request<Texture2D>("AAModClassic/Glowmasks/Solar_Glow");
        ...
        public override void AI()
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                if (Main.rand.NextBool(35))
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, value2.X, value2.Y, ModContent.ProjectileType<SolarFlare>(), Projectile.damage * (int)1.25f, Projectile.knockBack, player.whoAmI, num92, num91);
                }
            }
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position, Projectile.velocity, ModContent.ProjectileType<AkumaExplosionBlue>(), Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.whoAmI);
        }
    }
}
