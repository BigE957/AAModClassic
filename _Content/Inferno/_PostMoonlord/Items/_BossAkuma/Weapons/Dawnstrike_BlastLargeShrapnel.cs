...
{
    public class Dawnstrike_BlastLargeShrapnel : ModProjectile
    {
        ...
        public override void OnKill(int timeleft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X, Projectile.Center.Y, 0, 0, ModContent.ProjectileType<Dawnstrike_BlastLargeMiniShrapnel>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
