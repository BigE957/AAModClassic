...
namespace AAModClassic._Content.Inferno.__Hardmode.Items.Tiles.Decoration
{
    public class InfernoNightBox : BaseAAItem, ILocalizedModType
	{
        ...
        public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<InfernoNightBox_Tile>();
			Item.width = 24;
			Item.height = 24;
