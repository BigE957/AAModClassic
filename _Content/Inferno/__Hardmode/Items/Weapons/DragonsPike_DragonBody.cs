...
{
    public class DragonsPike_DragonBody : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (byUUID >= 0 && Main.projectile[byUUID].active)
            {
                ...
                if (Main.projectile[byUUID].type != ModContent.ProjectileType<DragonsPike_DragonHead>()) Main.projectile[byUUID].localAI[1] = Projectile.whoAmI;
            }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (player.slotsMinions + Projectile.minionSlots > player.maxMinions && Projectile.owner == Main.myPlayer)
            {
                ...
                if (byUUID != -1)
                {
                    ...
                    if (projectile1.type != ModContent.ProjectileType<DragonsPike_DragonHead>()) projectile1.localAI[1] = Projectile.localAI[1];
