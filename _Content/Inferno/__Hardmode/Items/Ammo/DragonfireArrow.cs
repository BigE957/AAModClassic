...
{
    public class DragonfireArrow : BaseAAItem, ILocalizedModType
	{
		...
		public override void SetDefaults()
		{
            ...
            Item.shoot = ModContent.ProjectileType<DragonfireArrow_Proj>();   //The projectile shoot when your weapon using this ammo
