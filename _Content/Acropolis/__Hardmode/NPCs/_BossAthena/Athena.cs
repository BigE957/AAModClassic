...
namespace AAModClassic._Content.Acropolis.__Hardmode.NPCs._BossAthena
{
    ...
    public class Athena : ModNPC
    {
        ...
        SassyBitchTex = ModContent.Request<Texture2D>("AAModClassic/_Content/Acropolis/__Hardmode/NPCs/_BossAthena/SassyBitch");
        }
    ...
    {
        public override string Texture => "AAModClassic/_Content/Acropolis/__Hardmode/NPCs/_BossAthena/Athena";
