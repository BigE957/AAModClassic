...
{
    public class AthenaA_SwiftwindSpear : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Swiftwind Spear");
        }
        ...
        public override void AI()
        {
            ...
            {
                Projectile.ai[0] = 0;
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position, Vector2.Zero, ModContent.ProjectileType<AthenaA_SwiftwindOrb>(), Projectile.damage / 2, 5, Main.myPlayer, 0, 0);
            }
        }
    }
}
