...
namespace AAModClassic._Content.Acropolis._PostMoonlord.NPCs.__BossAthenaA.Skies
{
    public class AthenaASkyScene : ModSceneEffect
    {
        public override bool IsSceneEffectActive(Player player) => NPC.AnyNPCs(ModContent.NPCType<AthenaA>());

        public override void SpecialVisuals(Player player, bool isActive)
        {
            player.ManageSpecialBiomeVisuals("AAModClassic:AthenaASky", isActive);
        }
    }

    public class AthenaASky : CustomSky
    {
