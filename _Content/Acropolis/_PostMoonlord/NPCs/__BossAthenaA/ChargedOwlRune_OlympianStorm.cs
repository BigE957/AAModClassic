...
{
    public class ChargedOwlRune_OlympianStorm : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            while (Projectile.numUpdates >= 0)
            {
                ...
                if (Projectile.frameCounter == 0 || Projectile.oldPos[0] == Vector2.Zero)
                {
                    ...
                    int num34 = Dust.NewDust(Projectile.oldPos[Projectile.oldPos.Length - 1], 0, 0, DustID.Electric, vector2.X, vector2.Y, 0);
