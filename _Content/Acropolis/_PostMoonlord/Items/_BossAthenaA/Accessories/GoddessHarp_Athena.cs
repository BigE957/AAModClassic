...
{
    public class GoddessHarp_Athena : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<GoddessHarp_Athena>();
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                if (flag25 && Projectile.ai[1] == 0f)
                {
                    ...
                    {
                        case 0:
                            num658 = ModContent.ProjectileType<GoddessHarp_VarianBurst>();
                            break;
                        case 1:
                            num658 = ModContent.ProjectileType<FeatherProjectile>();
                            ...
                            return;
                        case 2:
                            num658 = ModContent.ProjectileType<GoddessHarp_RazorGust>();
                            break;
                        case 3:
                            if (!AAGlobalProjectile.AnyProjectiles(ModContent.ProjectileType<AthenaHurricane>()) && !AAGlobalProjectile.AnyProjectiles(ModContent.ProjectileType<AthenaGale>()))
                            {
                                num658 = ModContent.ProjectileType<AthenaGale>();
                            }
                            else
                            {
                                goto case 1;
