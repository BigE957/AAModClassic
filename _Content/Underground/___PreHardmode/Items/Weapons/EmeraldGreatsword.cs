...
{
    public class EmeraldGreatsword : BaseAAItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.useTurn = true;
            Item.shoot = ModContent.ProjectileType<EmeraldGreatsword_EmeraldBolt>();
            Item.shootSpeed = 9f;
        }
        ...
        public override void AddRecipes()  //How to craft this sword
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<EmeraldSaber>(), 1);
