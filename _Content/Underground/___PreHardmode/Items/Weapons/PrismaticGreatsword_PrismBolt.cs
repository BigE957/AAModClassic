...
namespace AAModClassic._Content.Underground.___PreHardmode.Items.Weapons
{
    ...
    {
        public override (float, float, float) LightColor => ((Main.DiscoR - Projectile.alpha) * 0.8f / 255f, (Main.DiscoG - Projectile.alpha) * 0.4f / 255f, (Main.DiscoB - Projectile.alpha) * 0f / 255f);
