            ...
            if (Projectile.velocity.Y >= 0)
            {
                ...
                if (++Projectile.localAI[1] >= 60)
                {
                    ...
                    for (int i = 0; i < 12; ++i)
                    {
                        ...
                        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, vel * 2, ModContent.ProjectileType<GreedAHead_DesireSpark>(), Projectile.damage / 2, 0f, Main.myPlayer);
                    }
                    Projectile.Kill();
                }
            }
