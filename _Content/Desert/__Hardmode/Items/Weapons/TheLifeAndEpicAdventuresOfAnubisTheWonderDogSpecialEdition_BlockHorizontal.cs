...
namespace AAModClassic._Content.Desert.__Hardmode.Items.Weapons
{
    public class TheLifeAndEpicAdventuresOfAnubisTheWonderDogSpecialEdition_BlockHorizontal : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            BaseDrawing.DrawAfterimage(Main.spriteBatch, TextureAssets.Projectile[Projectile.type].Value, 0, Projectile, 2f, 1f, Math.Abs((int)Projectile.velocity.X), true, -2f, 0f, lightColor, frame, 6);
