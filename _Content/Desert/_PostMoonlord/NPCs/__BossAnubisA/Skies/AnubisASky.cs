...
namespace AAModClassic._Content.Desert._PostMoonlord.NPCs.__BossAnubisA.Skies
{
    public class AnubisASkyScene : ModSceneEffect
    {
        public override bool IsSceneEffectActive(Player player) => NPC.AnyNPCs(ModContent.NPCType<AnubisA>());

        public override void SpecialVisuals(Player player, bool isActive)
        {
            player.ManageSpecialBiomeVisuals("AAModClassic:AnubisASky", isActive);
        }
    }

    public class AnubisASky : CustomSky
    {
        public bool Active;
        ...
        public override void OnLoad()
        {
            ...
            {
                RuneTex[i] = ModContent.Request<Texture2D>(filePath + "Runes/AnubisASky_Rune" + i);
            }
        }
    ...
    public class AnubisASkyData : ScreenShaderData
    {
        ...
        {
            int anubis = ModContent.NPCType<AnubisA>();
