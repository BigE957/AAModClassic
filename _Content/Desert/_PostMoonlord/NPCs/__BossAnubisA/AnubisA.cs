...
namespace AAModClassic._Content.Desert._PostMoonlord.NPCs.__BossAnubisA
{
    ...
    public class AnubisA : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            switch (NPC.ai[0])
            {
                ...
                case 2:
                    ...
                    if (NPC.ai[1] > 160 && !AAGlobalProjectile.AnyProjectiles(ModContent.ProjectileType<AnubisA_CrookOfTheSoulJudge>()))
                    {
                        NPC.ai[0]++;
                        NPC.ai[1] = 0;
                        NPC.ai[2] = 0;
                ...
                case 3:
                    ...
                    if (NPC.ai[1] > 120 &&  Main.netMode != NetmodeID.MultiplayerClient)
                    {
                        ...
                        vel.Normalize();
                        vel *= 10f;
                        int type = ModContent.ProjectileType<AnubisA_SunSummon>();
                        for (int i = 0; i < Max; i++)
                        {
                ...
                case 5:
                    ...
                    if (NPC.life > NPC.lifeMax / 2)
                    {
                        if (NPC.ai[1] > 160 && !AAGlobalProjectile.AnyProjectiles(ModContent.ProjectileType<Anubis_BlockVertical>()))
                        {
                            internalAI[1]++;
                            if (internalAI[3] < TeleportCount && internalAI[1] >= 50)
                            {
                    ...
                    {
                        if (NPC.ai[1] > 240 && !AAGlobalProjectile.AnyProjectiles(ModContent.ProjectileType<AnubisA_BlockVertical>()))
                        {
                            internalAI[1]++;
                            if (internalAI[3] < TeleportCount && internalAI[1] >= 50)
                            {
        ...
        public override void OnKill()
        {
            ...
            if (!NPCExtensions.BeenKilled<AnubisA>(true))
            {
