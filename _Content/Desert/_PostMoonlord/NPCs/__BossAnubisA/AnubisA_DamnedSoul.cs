...
{
    public class AnubisA_DamnedSoul : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position, Vector2.Zero, ModContent.ProjectileType<AnubisA_ForsakenExplosion>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
            int pieCut = 20;
