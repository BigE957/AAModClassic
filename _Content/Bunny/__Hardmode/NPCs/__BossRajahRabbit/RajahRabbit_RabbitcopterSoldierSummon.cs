...
{
    public class RajahRabbit_RabbitcopterSoldierSummon : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num469 = Dust.NewDust(Projectile.Center, 0, 0, ModContent.DustType<Dusts.AbyssDust>(), 0f, 0f, 0, NPC.AnyNPCs(ModContent.NPCType<RajahRabbitA>()) ? Main.DiscoColor : new Color(107, 137, 179), 1f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                MinionType = ModContent.NPCType<SupremeRabbitcopterSoldier>();
            }
