...
{
    public class RoyalRabbit_Item : BaseAAItem
    {
        ...
        {
            int num = NPC.NewNPC(Item.GetSource_ReleaseEntity(), (int)(player.position.X + Main.rand.Next(-20, 20)), (int)(player.position.Y - 0f), ModContent.NPCType<RoyalRabbit_NPC>());
