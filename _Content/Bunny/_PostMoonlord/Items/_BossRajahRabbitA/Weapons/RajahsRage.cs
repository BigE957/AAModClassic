...
{
    public class RajahsRage : BaseAAItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<RajahsRage_RoyalRabbit>();
            Item.shootSpeed = 10f;
            Item.buffType = ModContent.BuffType<RajahsRage_Buff>();
            Item.autoReuse = true;
        }
