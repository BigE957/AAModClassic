...
{
    public class TheAvenger_Holdout : FlailHoldout
    {
        ...
        public override void AI()
        {
            ...
            if ((int)Projectile.ai[1] % 4 == 0 && Projectile.owner == Main.myPlayer)
            {
                ...
                int p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector55.X * 2, vector55.Y * 2, ModContent.ProjectileType<RajahCarrotEX>(), Projectile.damage, Projectile.knockBack, Projectile.owner, -10f, 0f);
