...
{
    public class ChampionHelmetSummoner_BaronBunny : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			{
				bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<ChampionHelmetSummoner_BaronBunny>();
				...
				if (flag25 && Projectile.ai[1] == 0f)
				{
                    ...
                    switch (num658)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            ModContent.ProjectileType<ChampionHelmetSummoner_BaronsSpear>();
                            break;
                        case 2:
                            ModContent.ProjectileType<ChampionHelmetSummoner_Carrot>();
                            break;
					...
					{
                        if (num658 == ModContent.ProjectileType<ChampionHelmetSummoner_Carrot>())
                        {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D Mad = ModContent.Request<Texture2D>(Texture + "Mad").Value;
            Texture2D Eyes = ModContent.Request<Texture2D>(Texture + "Eyes").Value;
            Texture2D Meter = ModContent.Request<Texture2D>(Texture + "BunnyMeter").Value;
            Texture2D MeterGlow = ModContent.Request<Texture2D>(Texture + "BunnyMeter_Glow").Value;
