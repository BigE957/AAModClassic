...
namespace AAModClassic._Content.Bunny._PostMoonlord.Items.Armor
{
    public class ChampionHelmetRangedSetEffect_Carrot : ModProjectile
	{
        ...
        public override void OnKill(int timeleft)
        {
            ...
            int p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), (int)Projectile.Center.X, (int)Projectile.Center.Y, 0, 0, ModContent.ProjectileType<ChampionHelmetRangedSetEffect_Explosion>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
