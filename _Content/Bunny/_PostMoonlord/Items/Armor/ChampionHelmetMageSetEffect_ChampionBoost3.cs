...
{
    public class ChampionHelmetMageSetEffect_ChampionBoost3 : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            {
                mplayer.CarrotBuff--;
                player.buffType[buffIndex] = ModContent.BuffType<ChampionHelmetMageSetEffect_ChampionBoost2>();
