...
{
    public class ArchwitchStaff : BaseAAItem, ILocalizedModType
    {
...
Right click to fire explosive magic bolts"); */
            ...
            ItemID.Sets.ShimmerTransformToItem[Type] = ModContent.ItemType<CatsEyeRifleEX>();
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<ArchwitchStaff_Proj>();
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<ArchwitchWand>());
