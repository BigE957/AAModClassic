...
namespace AAModClassic._Content._Dev.TEMPliz.projs
{
    public class ArchwitchStorm : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust dust19 = Main.dust[Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, ModContent.DustType<Dusts.ArchwitchDust>(), 0f, 0f, 0, default, 1f)];
            dust19.position = Projectile.Center;
            dust19.velocity = Vector2.Zero;
            dust19.noGravity = true;
            Dust dust18 = Main.dust[Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, ModContent.DustType<Dusts.ArchwitchDust>(), 0f, 0f, 0, default, 1f)];
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, ModContent.DustType<Dusts.ArchwitchDust>(), 0f, 0f, 100, default, 1.5f);
            }
            for (int num59 = 0; num59 < 4; num59++)
            {
                int num60 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, ModContent.DustType<Dusts.ArchwitchDust>(), 0f, 0f, 0, default, 2.5f);
                ...
                num60 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, ModContent.DustType<Dusts.ArchwitchDust>(), 0f, 0f, 100, default, 1.5f);
