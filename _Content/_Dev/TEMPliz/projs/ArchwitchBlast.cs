...
namespace AAModClassic._Content._Dev.TEMPliz.projs
{
    class ArchwitchBlast : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<ExtravagantLongsword_BigBoom>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 2, 0);
            int pieCut = 20;
