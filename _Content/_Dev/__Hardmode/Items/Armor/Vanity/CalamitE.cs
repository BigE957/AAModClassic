...
{
    public class CalamitE : TransformationAccessory, ILocalizedModType
    {
        ...
        [
            (EquipType.Head, "BigE_Shiny", null),
            (EquipType.Body, "BigE_Shiny", null),
            (EquipType.Legs, "BigE_Shiny", null),
        ];
