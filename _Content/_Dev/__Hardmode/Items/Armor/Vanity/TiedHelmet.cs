...
namespace AAModClassic._Content._Dev.__Hardmode.Items.Armor.Vanity   //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
