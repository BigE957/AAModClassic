...
{
    public class GameRaider_GameRocket : ModProjectile
	{
        ...
        {
            int pieCut = 20;
            SoundEngine.PlaySound(new SoundStyle("AAModClassic/Sounds/Moo"), Projectile.Center);
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.position.X, Projectile.position.Y, 0, 0, ModContent.ProjectileType<GameRaider_MooBoom>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
