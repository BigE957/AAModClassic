...
{
    public class DuckstepLauncher_Duck : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            int p = Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, new Vector2(0, 0), Projectile.ai[1] == 1 ? ModContent.ProjectileType<DuckstepLauncher_DucksplosionAlt>() : ModContent.ProjectileType<DuckstepLauncher_Ducksplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
            Main.projectile[p].Center = Projectile.Center;
        }

        public override bool PreDraw(ref Color lightColor)
        {
            Rectangle frame = BaseDrawing.GetFrame(Projectile.frame, TextureAssets.Projectile[Projectile.type].Width(), TextureAssets.Projectile[Projectile.type].Height() / 14, 0, 0);
