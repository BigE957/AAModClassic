...
namespace AAModClassic._Content._Dev._PostMoonlord.Items.Weapons
{
    public class ExtravagantLongsword_BigE : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<ExtravagantLongsword_BigBoom>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 1, 0);
            int pieCut = 20;
