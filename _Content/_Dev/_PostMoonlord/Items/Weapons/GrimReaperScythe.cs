...
-Gregg"); */
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<GrimReaperScythe_Proj>();
			Item.shootSpeed = 14f;
			Item.value = 500000;
		...
		{
			if (type == ModContent.ProjectileType<GrimReaperScythe_Proj>() && player.HasBuff(ModContent.BuffType<ReaperImmune_Buff>()))
			{
				damage /= 10;
			}
			return true;
