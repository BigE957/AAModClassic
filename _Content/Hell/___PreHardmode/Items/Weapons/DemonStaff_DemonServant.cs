...
{
    public class DemonStaff_DemonServant : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<DemonStaff_DemonServant>();
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                int num658 = ModContent.ProjectileType<DemonStaff_DemonSickle>();
