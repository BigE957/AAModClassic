...
{
    public class DemonStaff : BaseAAItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<DemonStaff_DemonServant>();
            Item.shootSpeed = 10f;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(source, vector2.X, vector2.Y, num78, num79, ModContent.ProjectileType<DemonStaff_DemonServant>(), num73, num74, i, 0f, 0f);
            return false;
        }
        ...
        public override void AddRecipes()  //How to craft this sword
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<SkullWand>(), 1);
