...
{
    public class DevilStaff_DevilServant : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (dust >= 0)
            {
                ...
                {
                    int num503 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y + 16f), Projectile.width, Projectile.height - 16, DustID.Torch, 0f, 0f, 0);
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<DevilStaff_DevilServant>();
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                int num658 = ModContent.ProjectileType<DevilStaff_UnholyTrident>();
