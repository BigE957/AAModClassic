...
namespace AAModClassic._Content.Stars._PostMoonlord.Items.Weapons
{
    ...
    public class StarStaff_Star1 : ModProjectile
	{
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            for (int n = 0; n < 5; n++)
            {
                ...
                num13 *= num16;
                num14 *= num16;
                int num17 = Projectile.NewProjectile(Projectile.GetSource_OnHit(target), x, y, num13, num14, ModContent.ProjectileType<StarStaff_Star2>(), 70, 5f, Main.myPlayer, 0f, 0f);
