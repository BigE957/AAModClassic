...
{
    public class DarkmatterSlasher_DarkmatterWave : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_Death(), (int)Projectile.position.X, (int)Projectile.position.Y, 0, 0, ModContent.ProjectileType<DarkmatterSlasher_RealityTear>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
