    ...
    public class DaybringerHead_DayStar : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if(Main.rand.NextBool(2))
            {
                ...
                int c = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(-12f, 0), ModContent.ProjectileType<DaybringerHead_DayRay>(), Projectile.damage, 3);
                int d = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(12f, 0), ModContent.ProjectileType<DaybringerHead_DayRay>(), Projectile.damage, 3);
            }
            else
            {
                int a = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(8f, -8f), ModContent.ProjectileType<DaybringerHead_DayRay>(), Projectile.damage, 3);
                int b = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(8f, 8f), ModContent.ProjectileType<DaybringerHead_DayRay>(), Projectile.damage, 3);
                int c = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(-8f, 8f), ModContent.ProjectileType<DaybringerHead_DayRay>(), Projectile.damage, 3);
                int d = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(-8f, -8f), ModContent.ProjectileType<DaybringerHead_DayRay>(), Projectile.damage, 3);
            }
