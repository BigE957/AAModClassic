    ...
    public class NightCloud : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[1] == aiTimerFire && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center.X, NPC.Center.Y, speed.X, speed.Y, ModContent.ProjectileType<NightcrawlerHead_Nothing>(), NPC.damage / 4, 0, Main.myPlayer);
            }
