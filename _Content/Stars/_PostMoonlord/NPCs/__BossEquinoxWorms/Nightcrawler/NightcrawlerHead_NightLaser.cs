...
{
    public class NightcrawlerHead_NightLaser : ModProjectile
    {
    	public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Night Laser");
		}
        ...
        public override void AI()
        {
            ...
            while (Projectile.numUpdates >= 0)
            {
                ...
                if (Projectile.frameCounter == 0 || Projectile.oldPos[0] == Vector2.Zero)
                {
                    ...
                    int num34 = Dust.NewDust(Projectile.oldPos[Projectile.oldPos.Length - 1], 0, 0, ModContent.DustType<Dusts.NightcrawlerDust>(), vector2.X, vector2.Y, 0);
            ...
            if (Projectile.velocity == Vector2.Zero)
            {
                ...
                if (Main.rand.Next(Projectile.extraUpdates) == 0)
                {
                    for (int num850 = 0; num850 < 2; num850++)
                    {
                        ...
                        int num853 = Dust.NewDust(Projectile.Center, 0, 0, ModContent.DustType<Dusts.NightcrawlerDust>(), vector84.X, vector84.Y, 0);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int num291 = 0; num291 < 3; num291++)
            {
                if (num291 == 0)
                {
                    ...
                    DelegateMethods.c_1 = new Color(0, 255, 181) * 0.5f;
                }
                else if (num291 == 1)
                {
                    scale16 = new Vector2(Projectile.scale) * 0.4f;
                    DelegateMethods.c_1 = AAColor.Nightcrawler * 0.5f;
                }
                else
                {
