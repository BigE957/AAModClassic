...
namespace AAModClassic._Content.Stars._PostMoonlord.NPCs._BossEquinox
{
    public class NightclawerDeathray : ModProjectile
    {
		...
		{
			// DisplayName.SetDefault("Nightclawer Deathray");
		}
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D20 = ModContent.Request<Texture2D>("AAModClassic/_Content/Stars/_PostMoonlord/NPCs/_BossEquinox/NightclawerDeathray2").Value;
            Texture2D texture2D21 = ModContent.Request<Texture2D>("AAModClassic/_Content/Stars/_PostMoonlord/NPCs/_BossEquinox/NightclawerDeathray3").Value;
    ...
    {
        public override string Texture => "AAModClassic/_Content/Stars/_PostMoonlord/NPCs/_BossEquinox/NightclawerDeathray";
        ...
        public override void OnKill(int timeLeft)
        {
            if (Main.netMode != NetmodeID.MultiplayerClient)
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<NightclawerDeathray>(), Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.ai[0], Projectile.ai[1]);
