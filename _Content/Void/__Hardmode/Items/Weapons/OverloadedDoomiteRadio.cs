...
namespace AAModClassic._Content.Void.__Hardmode.Items.Weapons
{
    public class OverloadedDoomiteRadio : BaseAAItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<OverloadedDoomiteRadio_VoidScout>();
            Item.shootSpeed = 10f;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(source, vector2.X, vector2.Y, 0, 0, ModContent.ProjectileType<OverloadedDoomiteRadio_VoidScout>(), num73, num74, i, 0f, 0f);
            return false;
        }
