        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (flag && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    dust = Main.dust[Dust.NewDust(position, 42, 47, DustID.Electric, 0f, 0f, 0, new Color(255, 0, 0), 1.513158f)];
...
<<<<<<< HEAD:_Content/Void/_PostMoonlord/NPCs/_BossZero/GenocideCannon.cs
            Texture2D glowTex = ModContent.Request<Texture2D>(Texture + "_Glow").Value;
=======
            Texture2D glowTex = Glowmask.Value;
>>>>>>> 670fbbe856f0c57fb0bd4e683d47971012388a1b:_Content/Void/_PostMoonlord/NPCs/__BossZero/ZeroGenocideCannon.cs
