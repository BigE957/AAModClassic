...
{
    public class ZeroGenocideCannon_GenocideRocket : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<ZeroGenocideCannon_GenocideBoom>(), Projectile.damage, 1, Projectile.owner);
        }
