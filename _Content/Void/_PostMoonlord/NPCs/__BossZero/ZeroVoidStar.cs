...
{
    [AutoloadBossHead]
    public class ZeroVoidStar : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            [
                new ColoredFlavorTextBestiaryInfoElement("Mods.AAModClassic.Bestiary.ZeroVoidStar", AAColor.OblivionDialogue)
            ]);
        }
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[2] == aiTimerFire)
            {
                ...
                if (Collision.CanHit(NPC.position, NPC.width, NPC.height, player.Center, player.width, player.height))
                {
                    ...
                    BaseAI.FireProjectile(player.Center, fireTarget, ModContent.ProjectileType<ZeroVoidStar_VoidStorm>(), NPC.damage / 2, 0f, 4f);
                }
            }
