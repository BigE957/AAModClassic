...
{
    [AutoloadBossHead]
    public class ZeroOmegaVolley : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[2] >= aiTimerFire)
            {
                if (Collision.CanHit(NPC.position, NPC.width, NPC.height, player.Center, player.width, player.height))
                {
                    ...
                    BaseAI.ShootPeriodic(NPC, player.position, player.width, player.height, ModContent.ProjectileType<ZeroOmegaVolley_OmegaBullet>(), ref NPC.ai[3], 6, (int)(NPC.damage * .75f), 10, true);
                }
                if (NPC.ai[2] > 360)
                {
                    NPC.ai[2] = 0;
...
<<<<<<< HEAD:_Content/Void/_PostMoonlord/NPCs/_BossZero/OmegaVolley.cs
            Texture2D glowTex = ModContent.Request<Texture2D>(Texture + "_Glow").Value;
=======
            Texture2D glowTex = Glowmask.Value;
>>>>>>> 670fbbe856f0c57fb0bd4e683d47971012388a1b:_Content/Void/_PostMoonlord/NPCs/__BossZero/ZeroOmegaVolley.cs
