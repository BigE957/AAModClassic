...
namespace AAModClassic._Content.Void._PostMoonlord.NPCs.__BossZero.Awakened
{
    internal class ZeroA_GlitchBlast : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.position, Vector2.Zero, ModContent.ProjectileType<ZeroA_b00m>(), Projectile.damage, 2, Projectile.owner);
        }
