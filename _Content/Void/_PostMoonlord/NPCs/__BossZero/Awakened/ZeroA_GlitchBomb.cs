...
{
    public class ZeroA_GlitchBomb : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<ZeroA_b00m>(), Projectile.damage, 1, Projectile.owner);
        }
