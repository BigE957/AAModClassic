...
{
    public class ZeroA_EchoGigablast : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1]++ == 120 && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                {
                    case 0f:
                        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(10, 0), ModContent.ProjectileType<ZeroA_EchoDeathray>(), 70, 3f, Main.myPlayer, 0, Projectile.whoAmI);
                        break;
                    case 1f:
                        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(-10, 0), ModContent.ProjectileType<ZeroA_EchoDeathray>(), 70, 3f, Main.myPlayer, 0, Projectile.whoAmI);
                        break;
                    case 2f:
                        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(0, 10), ModContent.ProjectileType<ZeroA_EchoDeathray>(), 70, 3f, Main.myPlayer, 0, Projectile.whoAmI);
                        break;
                    default:
                        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(0, -10), ModContent.ProjectileType<ZeroA_EchoDeathray>(), 70, 3f, Main.myPlayer, 0, Projectile.whoAmI);
                        break;
