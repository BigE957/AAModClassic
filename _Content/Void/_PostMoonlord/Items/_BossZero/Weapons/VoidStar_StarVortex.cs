...
{
    public class VoidStar_StarVortex : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D Vortex = ModContent.Request<Texture2D>("AAModClassic/_Content/Void/__Hardmode/Items/Weapons/SingularityCannon_SingularityVortexBack").Value;
