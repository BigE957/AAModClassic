...
namespace AAModClassic._Content.Void._PostMoonlord.Items._BossZero.Weapons
{
    internal class GenocideCannon_01010011 : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.position, Vector2.Zero, ModContent.ProjectileType<GenocideCannon_b00m>(), Projectile.damage, 2, Projectile.owner);
        }
