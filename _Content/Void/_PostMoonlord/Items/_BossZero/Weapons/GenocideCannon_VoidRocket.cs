...
namespace AAModClassic._Content.Void._PostMoonlord.Items._BossZero.Weapons
{
    public class GenocideCannon_VoidRocket : ModProjectile
	{
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), (int)Projectile.position.X, (int)Projectile.position.Y, 0, 0, ModContent.ProjectileType<GenocideCannon_GenocideBoom>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
            for (int i = 0; i < 20; i++)
            {
