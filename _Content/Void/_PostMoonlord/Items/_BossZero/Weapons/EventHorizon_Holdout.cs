...
{
    public class EventHorizon_Holdout : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            if (Main.netMode != NetmodeID.Server)
            {
                ...
                glowMasks[glowMasks.Length - 1] = ModContent.Request<Texture2D>("AAModClassic/Glowmasks/EventHorizon_Proj_Glow");
