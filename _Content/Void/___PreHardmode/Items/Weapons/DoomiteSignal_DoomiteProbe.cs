...
{
    public class DoomiteSignal_DoomiteProbe : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<DoomiteSignal_DoomiteProbe>();
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                int num658 = ProjectileID.MiniRetinaLaser;
