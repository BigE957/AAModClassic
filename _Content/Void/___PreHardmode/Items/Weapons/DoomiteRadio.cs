...
{
    public class DoomiteRadio : BaseAAItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<DoomiteRadio_DoomiteRadioProbe>();
            Item.shootSpeed = 10f;
            Item.buffType = ModContent.BuffType<DoomiteRadio_Buff>();
            Item.autoReuse = true;
