...
namespace AAModClassic._Content.Void.___PreHardmode.Items.Weapons
{
    public class DoomiteRadio_DoomiteRadioProbe : ModProjectile
	{
        ...
        {
            bool flag64 = Projectile.type == ModContent.ProjectileType<DoomiteRadio_DoomiteRadioProbe>();
            Player player = Main.player[Projectile.owner];
            ZAAPlayer modPlayer = player.GetModPlayer<ZAAPlayer>();
            player.AddBuff(ModContent.BuffType<DoomiteRadio_Buff>(), 3600);
            if (flag64)
            {
                if (player.dead)
                {
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<DoomiteRadio_DoomiteRadioProbe>();
