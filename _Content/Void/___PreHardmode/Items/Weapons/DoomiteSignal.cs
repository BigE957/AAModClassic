...
{
    public class DoomiteSignal : BaseAAItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<DoomiteSignal_DoomiteProbe>();
            Item.shootSpeed = 10f;
            Item.buffType = ModContent.BuffType<DoomiteSignal_Buff>();
            Item.autoReuse = true;
