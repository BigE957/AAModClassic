...
{
    public class OuroborosWoodWorkbench : ModItem, ILocalizedModType
    {
        public new string LocalizationCategory => "Items.Placeables.Furniture.OuroborosWood";
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Ouroboros Wood Workbench");
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 250;
            Item.createTile = ModContent.TileType<OuroborosWoodWorkbench_Tile>();
        }
