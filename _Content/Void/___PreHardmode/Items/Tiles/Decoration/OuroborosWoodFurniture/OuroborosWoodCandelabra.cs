...
{
    public class OuroborosWoodCandelabra : ModItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<OuroborosWoodCandelabra_Tile>();
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<OuroborosWood>(), 5)
