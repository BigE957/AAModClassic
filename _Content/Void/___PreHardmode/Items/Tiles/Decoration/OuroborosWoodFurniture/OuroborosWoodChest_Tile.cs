...
{
    public class OuroborosWoodChest_Tile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            // name.SetDefault("Ouroboros Wood Chest");
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Ouroboros Chest";
                if (player.cursorItemIconText == "Ouroboros Chest")
                {
                    player.cursorItemIconID = ModContent.ItemType<OuroborosWoodChest>();
