...
{
    public class OuroborosWoodLantern : ModItem, ILocalizedModType
    {
        public new string LocalizationCategory => "Items.Placeables.Furniture.OuroborosWood";
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Ouroboros Wood Lantern");
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 250;
            Item.createTile = ModContent.TileType<OuroborosWoodLantern_Tile>();
        }
