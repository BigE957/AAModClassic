...
{
    public class OroborosWoodClock : ModItem, ILocalizedModType
    {
        public new string LocalizationCategory => "Items.Placeables.Furniture.OroborosWood";
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Oroboros Wood Clock");
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 250;
            Item.createTile = ModContent.TileType<OroborosWoodClock_Tile>();
        }
