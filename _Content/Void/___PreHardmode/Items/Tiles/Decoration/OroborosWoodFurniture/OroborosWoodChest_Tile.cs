...
{
    public class OroborosWoodChest_Tile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            // name.SetDefault("Oroboros Wood Chest");
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<OroborosWoodChest>();
        ...
        public override void PostDraw(int x, int y, SpriteBatch sb)
        {
            ...
            Texture2D glowTex = ModContent.Request<Texture2D>("AAModClassic/Tiles/Furniture/Oroboros/OroborosChest_Tile_Glow").Value;
