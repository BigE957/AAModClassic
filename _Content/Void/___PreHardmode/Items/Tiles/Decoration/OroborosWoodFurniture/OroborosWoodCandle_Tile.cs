...
{
    public class OroborosWoodCandle_Tile : ModTile
    {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem)
        {
            ...
            {
                Item.NewItem(Entity.GetSource_NaturalSpawn(), i * 16, j * 16, 48, 48, ModContent.ItemType<OroborosWoodCandle>());
            }
        }
