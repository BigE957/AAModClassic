...
namespace AAModClassic._Content.Void.___PreHardmode.Items.Armor
{
    ...
    public class OroborosHelmet : BaseAAItem
    {
        ...
        {
            return body.type == ModContent.ItemType<OroborosChestplate>() && legs.type == ModContent.ItemType<OroborosLeggings>();
        }

        public override void UpdateArmorSet(Player player)
        {
            player.setBonus = Language.GetTextValue("Mods.AAModClassic.Common.OroborosHelmetBonus");
