...
{
    public class DoomiteHelmetSetEffect_Searcher : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			{
				bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<DoomiteHelmetSetEffect_Searcher>();
