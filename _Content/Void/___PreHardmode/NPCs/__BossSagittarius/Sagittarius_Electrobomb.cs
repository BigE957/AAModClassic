...
namespace AAModClassic._Content.Void.___PreHardmode.NPCs.__BossSagittarius
{
    public class Sagittarius_Electrobomb : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y + 20, 0, 0, ModContent.ProjectileType<Sagittarius_Electrosphere>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Rectangle frame = BaseDrawing.GetFrame(Projectile.frame, TextureAssets.Projectile[Projectile.type].Width(), TextureAssets.Projectile[Projectile.type].Height() / 11, 0, 0);
