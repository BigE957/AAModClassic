...
namespace AAModClassic._Content.GlowingMushroom.___PreHardmode.NPCs.__BossTruffleToad
{
    public class TruffleToad_Puffball : ModProjectile
	{
        ...
        {
            target.AddBuff(ModContent.BuffType<Buffs.Shroomed_Buff>(), 200);
        }
        ...
        public override void OnKill(int timeleft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, Projectile.velocity.X, Projectile.velocity.Y, ModContent.ProjectileType<TruffleToad_GlowingExplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
    }
}
