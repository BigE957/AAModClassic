...
namespace AAModClassic._Content.GlowingMushroom.___PreHardmode.Items._BossTruffleToad.Weapons
{
    public class MushrockStaff_Rock : ModProjectile
    {
        ...
        public override bool PreKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<MushrockStaff_Kashroom>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0, 0);
            int pieCut = 20;
