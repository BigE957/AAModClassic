...
namespace AAModClassic._Content.Hallow.__Hardmode.Items.Weapons
{
    public class TrueHallowStaff_TrueHallowedPrism : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<TrueHallowStaff_TrueHallowedPrism>();
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                int num658 = ModContent.ProjectileType<TrueHallowStaff_TruePrismShot>();
