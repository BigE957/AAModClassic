...
{
    public class TruePaladinsSmeltery_Tile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AdjTiles = new int[]
            {
                ...
                ModContent.TileType<PaladinsSmeltery_Tile>(),
                TileID.MythrilAnvil,
                TileID.Anvils,
                TileID.CrystalBall,
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(ModContent.Request<Texture2D>(Texture + "_Glow").Value, new Vector2((i * 16) - (int)Main.screenPosition.X, (j * 16) - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.TileFrameX, tile.TileFrameY + (Main.tileFrame[Type] * AnimationFrameHeight), 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
        }
