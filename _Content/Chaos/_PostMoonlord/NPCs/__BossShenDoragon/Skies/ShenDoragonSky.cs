...
{
    public class ShenDoragonSkyScene : ModSceneEffect
    {
        ...
        {
            player.ManageSpecialBiomeVisuals("AAModClassic:ShenDoragonSky", isActive);
        }
    }

    public class ShenDoragonSky : CustomSky
    {
        public bool Active;
    ...
    public class ShenDoragonSkyData : ScreenShaderData
    {
        private int ShenIndex;

        public ShenDoragonSkyData(string passName) : base(passName)
        {
        }
