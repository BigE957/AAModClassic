...
namespace AAModClassic._Content.Chaos._PostMoonlord.NPCs.__BossShenDoragon.Awakened.Skies
{
    ...
    public class ShenASky : CustomSky
    {
        ...
        public static Asset<Texture2D> MeteorTex => ShenSky.MeteorTex;
        public static Asset<Texture2D> SkyTex;

        public override void OnLoad()
        {
            string filePath = "AAModClassic/_Content/Chaos/_PostMoonlord/NPCs/__BossShenDoragon/Awakened/Skies/ShenASky_";
