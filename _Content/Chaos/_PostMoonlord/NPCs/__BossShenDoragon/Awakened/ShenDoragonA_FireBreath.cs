...
{
    public class ShenDoragonA_FireBreath : FireProj
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] > 7f)
            {
                ...
                Projectile.ai[0] += 1f;
                int num297 = ModContent.DustType<Dusts.Discord_Dust>();
        ...
        {
            target.AddBuff(ModContent.BuffType<DiscordianInferno_Buff>(), 180);
        }
    }
}