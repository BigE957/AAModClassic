...
using AAModClassic._Content.Chaos._PostMoonlord.NPCs.__BossShenDoragon.Projectiles;
...
namespace AAModClassic._Content.Chaos._PostMoonlord.NPCs.__BossShenDoragon
{
    ...
    public class Shen : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.AnyNPCs(ModContent.NPCType<BlazeGrip>()) || NPC.AnyNPCs(ModContent.NPCType<AbyssGrip>()))
            {
                if (NPC.alpha > 50)
                {
                    NPC.alpha = 50;
