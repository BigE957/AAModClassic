...
{
    public class ShenDoragon_Hitbox : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            if (Main.npc[(int)NPC.ai[0]].type == ModContent.NPCType<ShenDoragonA>())
                NPC.damage = 130;
        }
        public override bool PreAI()
        {
            ...
            if (boss < 0 || boss >= 200 || !Main.npc[boss].active || (Main.npc[boss].type != ModContent.NPCType<ShenDoragon>() || Main.npc[boss].type != ModContent.NPCType<ShenDoragonA>()))
            {
                NPC.active = false;
                return false;
            }
