...
using static AAModClassic._Content.Chaos._PostMoonlord.NPCs._BossSisters.Ashe.Ashe;


namespace AAModClassic._Content.Chaos._PostMoonlord.NPCs._BossSisters.Haruka
{
    [AutoloadBossHead]
    public class Haruka : ModNPC
    {
        ...
        {
            Texture2D glowTex = ModContent.Request<Texture2D>("AAModClassic/Glowmasks/Haruka_Glow").Value;
