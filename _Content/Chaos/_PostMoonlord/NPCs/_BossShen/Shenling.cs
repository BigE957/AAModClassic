...
namespace AAModClassic._Content.Chaos._PostMoonlord.NPCs._BossShen
{
	...
	{
        public override string Texture => "AAModClassic/_Content/Chaos/_PostMoonlord/NPCs/_BossShen/Shenling";
    ...
    {
        public override string Texture => "AAModClassic/_Content/Chaos/_PostMoonlord/NPCs/_BossShen/ShenlingBody1";
    ...
    {
        public override string Texture => "AAModClassic/_Content/Chaos/_PostMoonlord/NPCs/_BossShen/ShenlingBody2";
    ...
    {
        public override string Texture => "AAModClassic/_Content/Chaos/_PostMoonlord/NPCs/_BossShen/ShenlingTail";
