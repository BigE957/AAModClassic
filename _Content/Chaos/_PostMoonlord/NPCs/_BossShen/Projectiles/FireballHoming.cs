...
namespace AAModClassic._Content.Chaos._PostMoonlord.NPCs._BossShen.Projectiles
{
    ...
    {
        public override string Texture => "AAModClassic/_Content/Chaos/_PostMoonlord/NPCs/_BossShen/Projectiles/FireballHomingR";
    ...
    {
        public override string Texture => "AAModClassic/_Content/Chaos/_PostMoonlord/NPCs/_BossShen/Projectiles/FireballHomingB";
