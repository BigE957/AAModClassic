...
namespace AAModClassic._Content.Chaos._PostMoonlord.NPCs._BossShen.Projectiles
{
    ...
    {
        public override string Texture => "AAModClassic/_Content/Chaos/_PostMoonlord/NPCs/_BossShen/Projectiles/FireballAccelR";
    ...
    {
        public override string Texture => "AAModClassic/_Content/Chaos/_PostMoonlord/NPCs/_BossShen/Projectiles/FireballAccelB";
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Fireball");
            Main.projFrames[Projectile.type] = 4;
