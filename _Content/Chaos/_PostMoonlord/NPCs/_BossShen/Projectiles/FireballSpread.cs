...
namespace AAModClassic._Content.Chaos._PostMoonlord.NPCs._BossShen.Projectiles
{
    ...
    {
        public override string Texture => "AAModClassic/_Content/Chaos/_PostMoonlord/NPCs/_BossShen/Projectiles/FireballSpreadR";
    ...
    {
        public override string Texture => "AAModClassic/_Content/Chaos/_PostMoonlord/NPCs/_BossShen/Projectiles/FireballSpreadB";
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Fireball");
            Main.projFrames[Projectile.type] = 4;
