...
namespace AAModClassic._Content.Chaos._PostMoonlord.NPCs.__BossSistersOfDiscord.Ashe
{
    public class AsheVanish : ModNPC
    {
        ...
        {
            Texture2D glowTex = ModContent.Request<Texture2D>(Texture + "_Glow2").Value;
            Texture2D eyeTex = ModContent.Request<Texture2D>(Texture + "_Glow1").Value;
            ...
            spriteBatch.Draw(eyeTex, NPC.Center - screenPos, NPC.frame, Color.White, NPC.rotation, NPC.frame.Size() * 0.5f, NPC.scale, NPC.SpriteEffectDirection(true), 0);
