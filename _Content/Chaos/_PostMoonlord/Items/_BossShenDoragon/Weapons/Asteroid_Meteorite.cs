...
{
    public class Asteroid_Meteorite : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (TileHit)
            {
                int proj = Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X, Projectile.Center.Y + 20, Projectile.velocity.X, Projectile.velocity.Y, ModContent.ProjectileType<MeteorStrike_Proj>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
