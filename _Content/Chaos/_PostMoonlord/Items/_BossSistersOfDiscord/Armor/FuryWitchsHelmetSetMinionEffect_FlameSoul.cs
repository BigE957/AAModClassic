...
namespace AAModClassic._Content.Chaos._PostMoonlord.Items._BossSistersOfDiscord.Armor
{
    public class FuryWitchsHelmetSetMinionEffect_FlameSoul : ModProjectile
    {
        ...
        {
            bool flag64 = Projectile.type == ModContent.ProjectileType<FuryWitchsHelmetSetMinionEffect_FlameSoul>();
            Player player = Main.player[Projectile.owner];
            player.AddBuff(ModContent.BuffType<FuryWitchsHelmetSetMinionEffect_Buff>(), 3600);
            if (flag64)
            {
                if (!player.dead && player.GetModPlayer<FuryWitchsHelmetSetMinionPlayer>().effect)
                {
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                int num29 = ModContent.ProjectileType<FuryWitchsHelmetSetMinionEffect_FlameSoulShot>();
