    ...
    public class ChaosYari_Holdout : ModProjectile
    {
        ...
        public override void AI()
        {
        	...
        	if(Main.player[Projectile.owner].itemAnimation < Main.player[Projectile.owner].itemAnimationMax / 3)
        	{
				...
				if (Projectile.localAI[0] == 0f && Main.myPlayer == Projectile.owner && !AAGlobalProjectile.AnyProjectiles(ModContent.ProjectileType<ChaosYari_Proj>()))
				{
					Projectile.localAI[0] = 1f;
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Main.player[Projectile.owner].position.X, Main.player[Projectile.owner].position.Y, Projectile.velocity.X * 1.4f, Projectile.velocity.Y * 1.4f, ModContent.ProjectileType<ChaosYari_Proj>(), (int)((double)Projectile.damage * 0.85f), Projectile.knockBack * 0.85f, Projectile.owner, 0f, 0f);
				}
        	}
        	else
        	{
