...
{
    public class ChaosRitual_ChaosConstruct : ModProjectile
    {
		...
		public override void AI()
		{
			...
			{
				bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<ChaosRitual_ChaosConstruct>();
			...
			if (Projectile.ai[0] == 0f)
			{
				...
				if (flag25 && Projectile.ai[1] == 0f)
				{
					...
					if (Main.myPlayer == Projectile.owner && Collision.CanHitLine(Projectile.position, Projectile.width, Projectile.height, vector46, 0, 0))
					{
						...
						Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, value19.X, value19.Y, ModContent.ProjectileType<ChaosRitual_ChaosFireball>(), (int)(Projectile.damage * 0.8f), 0f, Main.myPlayer, 0f, Main.rand.Next(2));
						Projectile.netUpdate = true;
					}
				}
			}
