...
namespace AAModClassic._Content.Chaos.__Hardmode.Items.Weapons
{
    public class ChaosRitual_ChaosFireball : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Rectangle frame = BaseDrawing.GetFrame(Projectile.frame, TextureAssets.Projectile[Projectile.type].Width(), TextureAssets.Projectile[Projectile.type].Height() / 4, 0);
