...
{
    public class ChaosRitual : BaseAAItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<ChaosRitual_ChaosConstruct>();
            Item.shootSpeed = 10f;
            Item.buffType = ModContent.BuffType<ChaosRitual_Buff>();
            Item.autoReuse = true;
        }
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(source, vector2.X, vector2.Y, 0, 0, ModContent.ProjectileType<ChaosRitual_ChaosConstruct>(), num73, num74, i, 0f, 0f);
            return false;
        }
