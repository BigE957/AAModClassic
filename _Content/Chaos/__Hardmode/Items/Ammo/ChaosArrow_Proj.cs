...
namespace AAModClassic._Content.Chaos.__Hardmode.Items.Ammo
{
    public class ChaosArrow_Proj : ModProjectile
	{
        ...
        public override void OnKill(int timeleft)
        {
            ...
            {
                num468 = Dust.NewDust(Projectile.Center, Projectile.width, Projectile.height, Main.rand.NextBool(2) ? ModContent.DustType<Dusts.IncineriteDust>() : ModContent.DustType<Dusts.AbyssiumDust>(), -Projectile.velocity.X * 0.2f,
