...
namespace AAModClassic._Content.Terrarium.__Hardmode.Items.Weapons
{
    public class TerraGauntlet_TerraSphere : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<TerraGauntlet_TerraSphere>();
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                int num658 = ModContent.ProjectileType<TerraGauntlet_SummonBlast>();
