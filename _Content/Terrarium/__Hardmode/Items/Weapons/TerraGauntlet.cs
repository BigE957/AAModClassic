...
{
    public class TerraGauntlet : BaseAAItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<TerraGauntlet_TerraSquid>();
            Item.buffType = ModContent.BuffType<TerraGauntlet_Buff>();
            Item.knockBack = 2;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                case 0:
                    shootMe = ModContent.ProjectileType<TerraGauntlet_TerraSquid>();
                    break;
                case 1:
                    shootMe = ModContent.ProjectileType<TerraGauntlet_TerraCrawler>();
                    break;
                case 2:
                    shootMe = ModContent.ProjectileType<TerraGauntlet_TerraSphere>();
                    break;
            }
