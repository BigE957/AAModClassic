...
{
    public class TerraWeaverBody : ModNPC, IBannerNPC
    {
        ...
        public override bool PreAI()
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                if (NPC.ai[0] == 0)
                {
                    ...
                    {
                        latestNPC = NPC.NewNPC(NPC.GetSource_FromThis(), (int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<TerraWeaverHead>(), NPC.whoAmI, 0, latestNPC);
