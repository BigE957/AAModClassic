...
using AAModClassic._Content.Terrarium.__Hardmode.NPCs._BossBiomiteCore.Projectiles;
...
namespace AAModClassic._Content.Terrarium.__Hardmode.NPCs._BossBiomiteCore;
