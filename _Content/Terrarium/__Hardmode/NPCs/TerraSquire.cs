...
namespace AAModClassic._Content.Terrarium.__Hardmode.NPCs
{
    public class TerraSquire : ModNPC, IBannerNPC
    {
        ...
        {
            Color color = ColorUtils.MultiLerpColor(Main.LocalPlayer.miscCounter % 100 / 100f, Lighting.GetColor(NPC.Center.ToTileCoordinates()), Lighting.GetColor(NPC.Center.ToTileCoordinates()), Color.LimeGreen, Lighting.GetColor(NPC.Center.ToTileCoordinates()), Color.LimeGreen, Lighting.GetColor(NPC.Center.ToTileCoordinates()));
