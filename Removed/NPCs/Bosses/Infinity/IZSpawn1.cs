...
using AAModClassic.Removed.Buffs;
...
namespace AAModClassic.Removed.NPCs.Bosses.Infinity
{
    public class IZSpawn1 : ModNPC
    {
		...
		public void SummonInfinity()
		{
             ...
             if(Main.netMode != 1)
			{
                ...
                for (int i = 0; i < Main.player.Length; i++)
                {
                    ...
                    if (player2 != null && player2.active && !player2.dead && player2.HasBuff(ModContent.BuffType<LockedOn>()))
                    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D SFrame2 = Mod.GetTexture("Removed/NPCs/Bosses/Infinity/IZSpawn2");
            Texture2D SFrame3 = Mod.GetTexture("Removed/NPCs/Bosses/Infinity/IZSpawn3");
            Texture2D SFrame4 = Mod.GetTexture("Removed/NPCs/Bosses/Infinity/IZSpawn4");
            Texture2D SFrame5 = Mod.GetTexture("Removed/NPCs/Bosses/Infinity/IZSpawn5");
            Texture2D SFrame6 = Mod.GetTexture("Removed/NPCs/Bosses/Infinity/IZSpawn6");
			...
			Texture2D infinityTex = Mod.GetTexture("Removed/NPCs/Bosses/Infinity/IZShadow");		
			NPC.position.Y += 72;
            if (StartTimer <= 0)
            {
