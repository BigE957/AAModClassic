...
namespace AAModClassic.Removed.NPCs.Bosses.Infinity
{
	...
	public class Infinity : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			NPC.netAlways = true;
			NPC.chaseable = true;
			Music = Mod.GetSoundSlot(SoundType.Music, "Removed/Sounds/Music/IZ");
			NPC.HitSound = SoundID.NPCHit44;
			NPC.DeathSound = Mod.GetLegacySoundSlot(SoundType.Sound, "Removed/Sounds/Sounds/IZRoar");
            NPC.scale *= 1.4f;
            //TODOIZ
            //bossBag/* tModPorter Note: Removed. Spawn the treasure bag alongside other loot via npcLoot.Add(ItemDropRule.BossBag(type)) */ = Mod.Find<ModItem>("IZCache").Type;
        }
        ...
        public override void AI()
		{
            ...
            if (Main.netMode != 2)
			{
				...
				if (roarTimer == 180)
				{
					SoundEngine.PlaySound(Mod.GetLegacySoundSlot(SoundType.Sound, "Removed/Sounds/Sounds/IZRoar"), NPC.Center);
				}
			}
        ...
        public override void HitEffect(NPC.HitInfo hit)
		{
			...
			if (NPC.life <= 0)
			{
                ...
                //TODOIZ
                /*
				Gore.NewGore(NPC.GetSource_FromAI(), NPC.Center, NPC.velocity * randomSpread * Main.rand.NextFloat(), Mod.Find<ModGore>("Removed/IZGore1").Type, 1.4f);
				Gore.NewGore(NPC.GetSource_FromAI(), NPC.Center, NPC.velocity * randomSpread * Main.rand.NextFloat(), Mod.Find<ModGore>("Removed/IZGore2").Type, 1.4f);
				Gore.NewGore(NPC.GetSource_FromAI(), NPC.Center, NPC.velocity * randomSpread * Main.rand.NextFloat(), Mod.Find<ModGore>("Removed/IZGore3").Type, 1.4f);
				Gore.NewGore(NPC.GetSource_FromAI(), NPC.Center, NPC.velocity * randomSpread * Main.rand.NextFloat(), Mod.Find<ModGore>("Removed/IZGore4").Type, 1.4f);
				Gore.NewGore(NPC.GetSource_FromAI(), NPC.Center, NPC.velocity * randomSpread * Main.rand.NextFloat(), Mod.Find<ModGore>("Removed/IZGore5").Type, 1.4f);
				*/
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            string ZeroTex = ("Removed/NPCs/Bosses/Infinity/IZHand1");
        ...
        public void DrawZero(SpriteBatch spriteBatch, string zeroTexture, string glowMaskTexture, NPC Zero, Color drawColor)
        {
            if (Zero != null && Zero.active && Zero.ModNPC != null && (Zero.ModNPC is IZHand1 || Zero.ModNPC is IZHand2))
            {
                ...
                string ArmTex = ("Removed/NPCs/Bosses/Infinity/IZArm");
