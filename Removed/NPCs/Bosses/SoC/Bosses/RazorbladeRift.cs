    ...
    class RazorbladeRift : ModProjectile
    {
        ...
        public override void OnKill(int timeleft)
        {
            ...
            for (int num326 = 0; num326 < num325; num326++)
            {
                ...
                int num327 = Dust.NewDust(vector8 + vector9, 0, 0, ModContent.DustType<CthulhuDust>(), vector9.X * 2f, vector9.Y * 2f, 100, default(Color), 1.4f);
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                if (Projectile.ai[1] < 1f)
                {
                    ...
                    int num329 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X - (float)(Projectile.direction * 30), Projectile.Center.Y - 4f, (float)(-(float)Projectile.direction) * 0.01f, 0f, ModContent.ProjectileType<Leviacane>(), num328, 4f, Projectile.owner, 16f, 15f);
                ...
                else
                {
                    ...
                    int num335 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), (float)(num331 * 16 + 8), (float)(num330 * 16 - 24), 0f, 0f, ModContent.ProjectileType<Leviacane2>(), num334, 4f, Main.myPlayer, 16f, 24f);
