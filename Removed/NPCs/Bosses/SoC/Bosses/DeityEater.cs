...
namespace AAModClassic.Removed.NPCs.Bosses.SoC.Bosses
{
    [AutoloadBossHead]
    public class DeityEater : ModNPC
    {
        public override string Texture { get { return "AAModClassic/Removed/NPCs/Bosses/SoC/Bosses/DeityEater"; } }
        ...
        public override bool PreAI()
        {
            ...
            if (fireAttack == true)
            {
                ...
                int proj2 = Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center.X + Main.rand.Next(-20, 20), NPC.Center.Y + Main.rand.Next(-20, 20), NPC.velocity.X * 1.6f, NPC.velocity.Y * 1.6f, Mod.Find<ModProjectile>("AFireProjHostile").Type, 20, 0, Main.myPlayer);
            ...
            if (Main.netMode != 1)
            {
                if (NPC.ai[0] == 0)
                {
                    ...
                    {
                        latestNPC = NPC.NewNPC(NPC.GetSource_FromThis(), (int)NPC.Center.X, (int)NPC.Center.Y, Mod.Find<ModNPC>("DeityEaterBody").Type, NPC.whoAmI, 0, latestNPC);
                        Main.npc[(int)latestNPC].realLife = NPC.whoAmI;
                        Main.npc[(int)latestNPC].ai[3] = NPC.whoAmI;
                        segment += 1;
                    }

                    latestNPC = NPC.NewNPC(NPC.GetSource_FromThis(), (int)NPC.Center.X, (int)NPC.Center.Y, Mod.Find<ModNPC>("DeityEaterTail").Type, NPC.whoAmI, 0, latestNPC);
                    Main.npc[(int)latestNPC].realLife = NPC.whoAmI;
                    Main.npc[(int)latestNPC].ai[3] = NPC.whoAmI;
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            if (NPC.life > 0)
            {
                ...
                while ((double)num121 < hit.Damage / (double)NPC.lifeMax * 3.0)
                {
                    ...
                    {
                        Dust.NewDust(NPC.position, NPC.width, NPC.height, ModContent.DustType<CthulhuDust>(), (float)hit.HitDirection, -1f, 0, Color.Transparent, 0.75f);
                    }
                    if (Main.rand.Next(2) == 0)
                    {
                        Dust dust39 = Main.dust[Dust.NewDust(NPC.position, NPC.width, NPC.height, ModContent.DustType<CthulhuDust>(), 0f, 0f, 0, default(Color), 1f)];
                    ...
                    for (int num122 = 0; num122 < NPC.oldPos.Length; num122++)
                    {
                        if (Main.rand.Next(4) == 0)
                        {
                            ...
                            if (Main.rand.Next(3) == 0)
                            {
                                Dust.NewDust(NPC.oldPos[num122], NPC.width, NPC.height, ModContent.DustType<CthulhuDust>(), (float)hit.HitDirection, -1f, 0, Color.Transparent, 0.75f);
                            }
                            if (Main.rand.Next(2) == 0)
                            {
                                Dust dust40 = Main.dust[Dust.NewDust(NPC.oldPos[num122], NPC.width, NPC.height, ModContent.DustType<CthulhuDust>(), 0f, 0f, 0, default(Color), 1f)];
        ...
        public override void ModifyHitByProjectile(Projectile projectile, ref NPC.HitModifiers modifiers)
        {
            ...
            //TODOSOC
            /*
            if (AAWorldRemoved.Anticheat == true)
            {
        ...
        */
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D GlowTex = Mod.GetTexture("Removed/Glowmasks/DeityEater_Glow");
    ...
    {
        public override string Texture { get { return "AAModClassic/Removed/NPCs/Bosses/SoC/Bosses/DeityEaterBody"; } }
        ...
        {
            Texture2D currentTex = TextureAssets.Npc[NPC.type].Value;
            Texture2D GlowTex = Mod.GetTexture("Removed/Glowmasks/DeityEaterBody_Glow");
    ...
    {
        public override string Texture { get { return "AAModClassic/Removed/NPCs/Bosses/SoC/Bosses/DeityEaterTail"; } }
        ...
        {
            Texture2D currentTex = TextureAssets.Npc[NPC.type].Value;
            Texture2D GlowTex = Mod.GetTexture("Removed/Glowmasks/DeityEaterTail_Glow");
