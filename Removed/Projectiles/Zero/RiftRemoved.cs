...
namespace AAModClassic.Removed.Projectiles.Zero
{
    // to investigate: Projectile.Damage, (8843)
    class RiftRemoved : ModProjectile
	{
        ...
        */
        ...
        public override void AI()
        {
            ...
            if (flag17)
            {
                ...
                {
                    int num258 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, ModContent.DustType<VoidDustRemoved>(), 0f, 0f, 100, new Color(120, 0, 30), 1f);
