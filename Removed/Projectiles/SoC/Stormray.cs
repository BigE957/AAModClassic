...
using AAModClassic.Removed.Items.Boss.SoC;
...
namespace AAModClassic.Removed.Projectiles.SoC
{
	public class Stormray : AAProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			if (mainTex == null)
			{
				mainTex = Mod.GetTexture("Removed/Projectiles/SoC/StormShockChainEnd3");
				chainTex = Mod.GetTexture("Removed/Projectiles/SoC/StormShockChain");
				chainEndTex = Mod.GetTexture("Removed/Projectiles/SoC/StormShockChainEnd");
			}
