...
using AAModClassic.Removed.NPCs.Bosses.SoC;
using AAModClassic.Base.BaseMod.Base;

namespace AAModClassic.Removed.Items.BossSummons
{
    public class CursedCompass : ModItem
    {
        ...
        private bool CthulhuFightable = AAWorld.downedAllAncients && !AAWorldRemoved.downedSoC;
