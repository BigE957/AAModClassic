...
namespace AAModClassic.Removed.Backgrounds
{
    public class ScreenCthulhuFog
    {
        ...
        public void Update(Texture2D texture)
        {
            ...
            bool CthulhuTime = Main.player[Main.myPlayer].InZone("Ocean") && AAWorld.downedAllAncients && !AAWorldRemoved.downedSoC;
            if (!backgroundFog && (BasePlayer.HasAccessory(player, ModContent.ItemType<Lantern>(), true, false) || AAWorldRemoved.downedSoC)) CthulhuTime = false;
