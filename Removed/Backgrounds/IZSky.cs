...
{
    public class IZSkyScene : ModSceneEffect
    {
        ...
        {
            player.ManageSpecialBiomeVisuals("AAModClassic:IZSky", isActive && player.Center.Y <= Main.worldSurface * 16);
        }
    ...
    public class IZSky : CustomSky
    {
        ...
        public static Texture2D boltTexture = ModContent.Request<Texture2D>("AAModClassic/Removed/Backgrounds/VoidBolt").Value;
        public static Texture2D flashTexture = ModContent.Request<Texture2D>("AAModClassic/Removed/Backgrounds/VoidFlash").Value;
        private Bolt[] bolts;
        public bool Active;
    ...
    public class IZSkyData : ScreenShaderData
    {
        ...
        {
            int IZType = ModContent.NPCType<Infinity>();
            int IZSpawmType = ModContent.NPCType<IZSpawn1>();
