...
namespace AAModClassic.Removed.Tiles.Fulgurite.Parthenan.Ancient
{
    public class AncientDataBank : ModTile
    {
        ...
        public override void PostDraw(int i, int j, Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch)
        {
            ...
            Main.spriteBatch.Draw(Mod.GetTexture("Removed/Glowmasks/AncientDataBank_Glow"), new Vector2((i * 16) - (int)Main.screenPosition.X, (j * 16) - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.TileFrameX, tile.TileFrameY, 16, height), color, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
        }
