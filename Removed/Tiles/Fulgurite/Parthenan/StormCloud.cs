...
namespace AAModClassic.Removed.Tiles.Fulgurite.Parthenan
{
    public class StormCloud : ModTile
    {
        ...
        public override void PostDraw(int x, int y, SpriteBatch sb)
        {
            ...
            Main.spriteBatch.Draw(Mod.GetTexture("Removed/Glowmasks/StormCloud_Glow"), new Vector2((x * 16) - (int)Main.screenPosition.X, (y * 16) - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.TileFrameX, tile.TileFrameY, 16, height), color, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
        }
