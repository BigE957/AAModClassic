...
namespace AAModClassic.NPCs.Bosses.Equinox
{
    public class DaybringerStars : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int a = Projectile.NewProjectile(Projectile.Center, new Vector2(0f, -12f), Mod.Find<ModProjectile>("DayBringerBlast").Type, Projectile.damage, 3);
                int b = Projectile.NewProjectile(Projectile.Center, new Vector2(0f, 12f), Mod.Find<ModProjectile>("DayBringerBlast").Type, Projectile.damage, 3);
                int c = Projectile.NewProjectile(Projectile.Center, new Vector2(-12f, 0), Mod.Find<ModProjectile>("DayBringerBlast").Type, Projectile.damage, 3);
                int d = Projectile.NewProjectile(Projectile.Center, new Vector2(12f, 0), Mod.Find<ModProjectile>("DayBringerBlast").Type, Projectile.damage, 3);
            }
            else
            {
                int a = Projectile.NewProjectile(Projectile.Center, new Vector2(8f, -8f), Mod.Find<ModProjectile>("DayBringerBlast").Type, Projectile.damage, 3);
                int b = Projectile.NewProjectile(Projectile.Center, new Vector2(8f, 8f), Mod.Find<ModProjectile>("DayBringerBlast").Type, Projectile.damage, 3);
                int c = Projectile.NewProjectile(Projectile.Center, new Vector2(-8f, 8f), Mod.Find<ModProjectile>("DayBringerBlast").Type, Projectile.damage, 3);
                int d = Projectile.NewProjectile(Projectile.Center, new Vector2(-8f, -8f), Mod.Find<ModProjectile>("DayBringerBlast").Type, Projectile.damage, 3);
            }
