...
namespace AAModClassic.NPCs.Bosses.Anubis.Forsaken
{
    public class BlockF1 : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            BaseDrawing.DrawAfterimage(sb, TextureAssets.Projectile[Projectile.type].Value, 0, Projectile, 2f, 1f, Math.Abs((int)Projectile.velocity.Y), true, 0f, 0f, Color.LightGreen, frame, 6);
