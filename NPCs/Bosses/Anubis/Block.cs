...
namespace AAMod.NPCs.Bosses.Anubis
{
    public class Block : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            BaseDrawing.DrawAfterimage(sb, TextureAssets.Projectile[Projectile.type].Value, 0, Projectile, 2f, 1f, Math.Abs((int)Projectile.velocity.X), true, 0f, 0f, dColor, frame, 6);
