...
public class SandstormProj : ModProjectile
{
	...
	public override void AI()
	{
		...
		if (Projectile.localAI[0] == 0f)
		{
			...
			Projectile.Center = new Vector2((float)(val3.X * 16 + 8), (float)(val3.Y * 16 + 8));
		}
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		Vector2 val2 = Projectile.position + new Vector2((float)Projectile.width, (float)Projectile.height) / 2f + Vector2.UnitY * Projectile.gfxOffY - Main.screenPosition;
		Rectangle val3 = Utils.Frame(val, 1, 1, 0, Projectile.frame);
		Main.spriteBatch.Draw(val, val2, (Rectangle?)val3, Projectile.GetAlpha(lightColor), 0f, val3.Size() / 2f, new Vector2(1f, 8f) * Projectile.scale, (SpriteEffects)0, 0f);
		...
		Main.spriteBatch.Draw(val, val2, (Rectangle?)val3, val5, 0f, val4, new Vector2(1f, 5f) * Projectile.scale * 2f, (SpriteEffects)0, 0f);
		Main.spriteBatch.Draw(val, val2, (Rectangle?)val3, alpha, Projectile.rotation, val4, Projectile.scale, (SpriteEffects)0, 0f);
		Main.spriteBatch.Draw(val, val2, (Rectangle?)val3, alpha, 0f, val4, new Vector2(1f, 8f) * Projectile.scale, (SpriteEffects)0, 0f);
		return false;
	}
}
