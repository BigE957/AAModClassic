...
namespace AAModClassic.NPCs.Bosses.Yamata.Awakened
{
    internal class HomingSoul : ModProjectile
    {
        ...
        public override void OnKill(int timeleft)
        {
            ...
            Projectile.NewProjectile(Projectile.position.X, Projectile.position.Y, Projectile.velocity.X, Projectile.velocity.Y, Mod.Find<ModProjectile>("SoulBoomY").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
