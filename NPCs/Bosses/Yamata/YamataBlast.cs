...
namespace AAMod.NPCs.Bosses.Yamata
{
    public class YamataBlast : ModProjectile
	{
        ...
        public override void OnKill(int timeleft)
        {
            ...
            Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y - 51 + 8, Projectile.velocity.X, Projectile.velocity.Y, Mod.Find<ModProjectile>("Shock").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
    }
}
