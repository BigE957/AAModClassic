...
namespace AAModClassic.NPCs.Enemies.Mushroom
{
    public class SmallToad : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.alpha = 255;
            Banner = NPC.type;
			BannerItem = ModContent.ItemType<Items.Banners.TinyToadBanner>();
        }
        ...
        {
            Item.NewItem(NPC.GetSource_Loot(), (int)NPC.position.X, (int)NPC.position.Y, NPC.width, NPC.height, ModContent.ItemType<Items.Boss.MushroomMonarch.GlowingMushium>(), Main.rand.Next(1, 5));
        }
    }
}