...
namespace AAModClassic.NPCs.Enemies.Terrarium.PreHM
{
    public class PuritySphere : ModNPC
	{
        ...
        public override void AI()
        {
            ...
            BaseAI.ShootPeriodic(NPC, player.position, player.width, player.height, ModContent.ProjectileType<PurityShot>()/*TerraShot*/, ref shootAI[0], 120, (int)(NPC.damage * (Main.expertMode ? 0.25f : 0.5f)), 3f, true, new Vector2(20f, 15f));
            if (NPC.alpha != 0)
            {
