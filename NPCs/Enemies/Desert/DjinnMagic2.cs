...
namespace AAModClassic.NPCs.Enemies.Desert
{
    public class DjinnMagic2 : ModProjectile
    {
        ...
        public override void OnKill(int timeleft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.position.X, Projectile.position.Y, Projectile.velocity.X, Projectile.velocity.Y, ModContent.ProjectileType<DjinnBurst2>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
