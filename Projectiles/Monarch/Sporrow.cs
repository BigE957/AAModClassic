...
namespace AAModClassic.Projectiles.Monarch
{
    public class Sporrow : ModProjectile
    {
        ...
        public override void OnKill(int timeleft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.position, Vector2.Zero, ModContent.ProjectileType<SporeCloud>(), Projectile.damage, 0, Main.myPlayer);
        }
    }
}
