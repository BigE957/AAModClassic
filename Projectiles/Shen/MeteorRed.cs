...
{
    public class MeteorRed : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int num469 = Dust.NewDust(Projectile.Center, Projectile.width, 1, ModContent.DustType<YamataADust>(), -Projectile.velocity.X * 0.2f,
