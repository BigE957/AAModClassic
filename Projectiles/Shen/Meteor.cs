...
namespace AAModClassic.Projectiles.Shen
{
    public class Meteor : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num190 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, ModContent.DustType<Discord>(), 0f, 0f, 0);
