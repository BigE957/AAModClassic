...
namespace AAModClassic.Projectiles.Shen
{
    public class TimesplitterP : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            velocityX *= num6;
            velocityY *= num6;
            Projectile p = Projectile.NewProjectileDirect(Projectile.GetSource_OnHit(target), new Vector2(screenX, screenY), new Vector2(velocityX, velocityY), ModContent.ProjectileType<CosmicBlow>(), damageDone*4, 0f, player.whoAmI);
            p.tileCollide = false;
        }
