    ...
    public class SunOrb : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            if (Main.rand.Next(2) == 0)
            {
                ...
                Dust dust31 = Main.dust[Dust.NewDust(Projectile.Center - vector135 * 30f, 0, 0, ModContent.DustType<AkumaADust>(), 0f, 0f, 0, default, 1f)];
            ...
            if (Main.rand.Next(2) == 0)
            {
                ...
                Dust dust32 = Main.dust[Dust.NewDust(Projectile.Center - vector136 * 30f, 0, 0, ModContent.DustType<AkumaADust>(), 0f, 0f, 0, default, 1f)];
            ...
            if (Projectile.ai[0] < 0f)
            {
                ...
                int num1059 = Dust.NewDust(center15 - Vector2.One * 8f, 16, 16, ModContent.DustType<AkumaADust>(), Projectile.velocity.X / 2f, Projectile.velocity.Y / 2f, 0);
