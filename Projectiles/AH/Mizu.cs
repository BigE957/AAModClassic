...
namespace AAModClassic.Projectiles.AH
{
    public class Mizu : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
		{
            ...
            {
                int num88 = Dust.NewDust(position, num84, height3, ModContent.DustType<CthulhuAuraDust>(), 0f, 0f, 200, default, 3.7f);
                ...
                num88 = Dust.NewDust(position, num84, height3, ModContent.DustType<CthulhuAuraDust>(), 0f, 0f, 100, default, 1.5f);
                Main.dust[num88].position = Projectile.Center + (Vector2.UnitY.RotatedByRandom(3.1415927410125732) * (float)Main.rand.NextDouble() * num84 / 2f);
            ...
            {
                int num90 = Dust.NewDust(position, num84, height3, ModContent.DustType<CthulhuAuraDust>(), 0f, 0f, 0, default, 2.7f);
