...
namespace AAModClassic.Projectiles.Zero
{
    public class Protocol : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float num635 = 1200f;
            float num636 = 150f;
            bool flag64 = Projectile.type == Mod.Find<ModProjectile>("Protocol").Type;
            ...
            {
                bool flag23 = Main.projectile[num638].type == Mod.Find<ModProjectile>("Protocol").Type;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            BaseDrawing.DrawTexture(spritebatch, TextureAssets.Projectile[Projectile.type].Value, 0, Projectile.position, Projectile.width, Projectile.height, Projectile.scale, Projectile.rotation, Projectile.spriteDirection, 7, frame, dColor, true);
