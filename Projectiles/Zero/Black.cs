...
namespace AAMod.Projectiles.Zero
{
    public class Black : ModProjectile
    {
		...
		public override void OnKill(int a)
		{
			if (!flag1)
			{
				Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, Main.rand.NextFloat(-2f, 2f), Main.rand.NextFloat(-2f, 2f), Mod.Find<ModProjectile>("CycloneF").Type, Projectile.damage / 3, 0.0f, Main.myPlayer, 0.0f, 0.0f);
			}
		}
