    ...
    public class ChaosScythe : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            if (!NoScythes)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X + 250, Projectile.Center.Y, -7, 0, ModContent.ProjectileType<ChaosScytheP>(), 250, 1, Projectile.owner, 0f, 0f);
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X - 250, Projectile.Center.Y, 7, 0, ModContent.ProjectileType<ChaosScytheP>(), 250, 1, Projectile.owner, 0f, 0f);
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X, Projectile.Center.Y + 250, 0, -7, ModContent.ProjectileType<ChaosScytheP>(), 250, 1, Projectile.owner, 0f, 0f);
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X, Projectile.Center.Y - 250, 0, 7, ModContent.ProjectileType<ChaosScytheP>(), 250, 1, Projectile.owner, 0f, 0f);
            }
        }
