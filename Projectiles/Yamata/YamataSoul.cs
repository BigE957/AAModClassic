...
namespace AAModClassic.Projectiles.Yamata
{
    class YamataSoul : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            dust1 = Main.dust[Dust.NewDust(new Vector2(Projectile.width, Projectile.height), Projectile.width, Projectile.height, ModContent.DustType<Dusts.YamataDust>(), 0f, 0f, 46, default, 1.381579f)];
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int num623 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, ModContent.DustType<Dusts.YamataDust>(), 0f, 0f, 0);
            ...
            {
                int num625 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, ModContent.DustType<Dusts.YamataDust>(), 0f, 0f, 0);
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                for (int num627 = 0; num627 < num626; num627 = num3 + 1)
                {
                    ...
                    num628 *= 10f;
                    num629 *= 10f;
                    int p = Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.position.X, Projectile.position.Y, num628, num629, ModContent.ProjectileType<SoulSplit>(), Projectile.damage * 3, (int)(Projectile.knockBack * 0.35), Main.myPlayer, 0f, 0f);
                    num3 = num627;
