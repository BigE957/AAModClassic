        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                for (int num627 = 0; num627 < num626; num627 = num3 + 1)
                {
                    ...
                    num628 *= 10f;
                    num629 *= 10f;
                    int p = Projectile.NewProjectile(Projectile.position.X, Projectile.position.Y, num628, num629, ModContent.ProjectileType<SoulSplit>(), Projectile.damage * 3, (int)(Projectile.knockBack * 0.35), Main.myPlayer, 0f, 0f);
                    num3 = num627;
