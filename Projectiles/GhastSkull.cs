...
namespace AAModClassic.Projectiles
{
    public class GhastSkull : ModProjectile
    {
        ...
        {
			Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X, Projectile.Center.Y, 0, 0, ModContent.ProjectileType<GhastBoom>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
