...
namespace AAModClassic.Projectiles.Thorium
{
    ...
    { 
		...
		public override void AI()
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X + 20, Projectile.Center.Y, -15f, 0f, Mod.Find<ModProjectile>("AuroraScytheDamage").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X - 20, Projectile.Center.Y, 15f, 0f, Mod.Find<ModProjectile>("AuroraScytheDamage").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
			
			if (Projectile.timeLeft == 13)
			{
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X + 20, Projectile.Center.Y, -15f, 0f, Mod.Find<ModProjectile>("AuroraScytheDamage2").Type, (int)(Projectile.damage * .35), Projectile.knockBack, Projectile.owner, 0f, 0f);
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X - 20, Projectile.Center.Y, 15f, 0f, Mod.Find<ModProjectile>("AuroraScytheDamage2").Type, (int)(Projectile.damage * .35), Projectile.knockBack, Projectile.owner, 0f, 0f);
			}
    ...
    public class AuroraScytheEffect : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int m = 0; m < 5; m++)
            {
                ...
                int dustID = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<IceDust>(), 0, 0, 0);
