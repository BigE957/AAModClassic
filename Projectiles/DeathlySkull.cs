...
namespace AAMod.Projectiles
{
    public class DeathlySkull : ModProjectile
    {
            ...
            if (Projectile.alpha > 0)
            {
                ...
                if (Projectile.alpha < 0)
                {
                    ...
                    while (num110 < num109)
                    {
                        ...
                        int num111 = Dust.NewDust(Projectile.Center, 0, 0, 6, 0f, 0f, 0);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int num86 = Dust.NewDust(position, num84, height3, 6, 0f, 0f, 100);
            ...
            {
                int num794 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 6, 0f, 0f, 0);
            ...
            {
                int num90 = Dust.NewDust(position, num84, height3, 6, 0f, 0f, 0);
