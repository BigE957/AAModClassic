    ...
    class DesertBlast : ModProjectile
    {
        ...
        public override void OnKill(int timeleft)
        {
			...
			for (int h = 0; h < 3; h++)
			{
				...
				vel *= 8f;
				Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X, Projectile.Center.Y, vel.X, vel.Y, ModContent.ProjectileType<FragBlast>(), Projectile.damage, 0, Main.myPlayer);
			}
        }
    }
}