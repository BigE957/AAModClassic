		...
		public override void AI()
		{
			...
			if (Main.player[Projectile.owner].itemAnimation < Main.player[Projectile.owner].itemAnimationMax / 3)
			{
				...
				if (Projectile.localAI[0] == 0f && Main.myPlayer == Projectile.owner)
				{
					...
					{
						Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X + Projectile.velocity.X, Projectile.Center.Y + Projectile.velocity.Y, Projectile.velocity.X * 2.6f, Projectile.velocity.Y * 2.6f, Mod.Find<ModProjectile>("AxisShot").Type, (int)(Projectile.damage * 0.8), Projectile.knockBack * 0.85f, Projectile.owner, 0f, 0f);
					}
				}
			}
			else
