...
{
    public class EquinoxWormsLore : LoreItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<DaybringerTrophy>());
            recipe.AddTile(TileID.Bookcases);
            recipe.Register();

            Recipe recipe2 = CreateRecipe();
            recipe2.AddIngredient(ModContent.ItemType<NightcrawlerTrophy>());
