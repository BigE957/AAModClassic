...
public class JojoBagginsPainting : ModTile
{
	...
	{
        Item.NewItem(Item.GetSource_NaturalSpawn(), i * 16, j * 16, 32, 48, ModContent.ItemType<AAModClassic.Items.Blocks.Paintings.JojoBagginsPainting>(), 1, false, 0, false, false);
	}
}
