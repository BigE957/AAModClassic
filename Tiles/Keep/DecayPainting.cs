...
public class DecayPainting : ModTile
{
	public override string HighlightTexture => "AAMod/Textures/LargeKeepPainting2_Highlight";
	...
	{
        Item.NewItem(Item.GetSource_NaturalSpawn(), i * 16, j * 16, 32, 48, ModContent.ItemType<AAModClassic.Items.Blocks.Paintings.DecayPainting>(), 1, false, 0, false, false);
	}
}
