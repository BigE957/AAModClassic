...
public class KeepCandle : ModTile
{
	public override void SetStaticDefaults()
	{
        ...
        RegisterItemDrop(ModContent.ItemType<AAModClassic.Items.Blocks.Keep.KeepCandle>());
	...
	public override void MouseOver(int i, int j)
	{
		...
		localPlayer.cursorItemIconID = ModContent.ItemType<AAModClassic.Items.Blocks.Keep.KeepCandle>();
	}
