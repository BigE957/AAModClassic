...
public class KeepBed : ModTile
{
	...
	{
        Item.NewItem(Item.GetSource_NaturalSpawn(), i * 16, j * 16, 64, 32, ModContent.ItemType<AAModClassic.Items.Blocks.Keep.KeepBed>(), 1, false, 0, false, false);
	}
	...
	public override void MouseOver(int i, int j)
	{
		...
		localPlayer.cursorItemIconID = ModContent.ItemType<AAModClassic.Items.Blocks.Keep.KeepBed>();
	}
}
