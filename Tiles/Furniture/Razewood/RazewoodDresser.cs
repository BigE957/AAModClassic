...
namespace AAMod.Tiles.Furniture.Razewood
{
    public class RazewoodDresser : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			dresser/* tModPorter Note: Removed. Override DefaultContainerName and use TileID.Sets.BasicDresser instead */ = "Razewood Dresser";
			ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = Mod.Find<ModItem>("RazewoodDresser").Type;
		}
