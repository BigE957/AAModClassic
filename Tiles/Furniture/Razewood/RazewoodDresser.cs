...
namespace AAModClassic.Tiles.Furniture.Razewood
{
    public class RazewoodDresser : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// name.SetDefault("Razewood Dresser");
            AddMapEntry(new Color(205, 62, 12), name);
            DustType = Mod.Find<ModDust>("RazewoodDust").Type;
			TileID.Sets.DisableSmartCursor[Type] = true;
			AdjTiles = new int[] { TileID.Dressers };
			TileID.Sets.BasicDresser[Type] = true; // Override DefaultContainerName and use TileID.Sets.BasicDresser instead */ = "Razewood Dresser";
		...
		{
			Item.NewItem(Item.GetSource_NaturalSpawn(), i * 16, j * 16, 48, 32, Mod.Find<ModItem>("RazewoodDresser").Type/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */);
