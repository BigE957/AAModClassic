...
public class TerraChest : ModTile
{
	...
	{
        Item.NewItem(Item.GetSource_NaturalSpawn(), i * 16, j * 16, 32, 32, ModContent.ItemType<AAModClassic.Items.Blocks.Terra.TerraChest>(), 1, false, 0, false, false);
