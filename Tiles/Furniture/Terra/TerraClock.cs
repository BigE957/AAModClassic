...
public class TerraClock : ModTile
{
	...
	{
        Item.NewItem(Item.GetSource_NaturalSpawn(), i * 16, j * 16, 48, 32, ModContent.ItemType<AAModClassic.Items.Blocks.Terra.TerraClock>(), 1, false, 0, false, false);
	}
}
