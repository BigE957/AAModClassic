...
public class TerraBed : ModTile
{
	...
	{
        Item.NewItem(Item.GetSource_NaturalSpawn(), i * 16, j * 16, 64, 32, ModContent.ItemType<AAModClassic.Items.Blocks.Terra.TerraBed>(), 1, false, 0, false, false);
	}
