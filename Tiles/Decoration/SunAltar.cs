...
namespace AAModClassic.Tiles.Decoration
{
    public class SunAltar : ModTile
    {
        ...
        {
            Item.NewItem(Item.GetSource_NaturalSpawn(), i * 16, j * 16, 32, 48, Mod.Find<ModItem>("SunAltar").Type);
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = Mod.Find<ModItem>("SunAltar").Type;
        }
