...
{
    internal class Orthrus_Breath : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] > 7f)
            {
                ...
                if (Main.rand.Next(2) == 0)
                {
                    ...
                    {
                        int num299 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, Mod.Find<ModDust>("FulguriteDust").Type, Projectile.velocity.X * 0.2f, Projectile.velocity.Y * 0.2f, 100);
