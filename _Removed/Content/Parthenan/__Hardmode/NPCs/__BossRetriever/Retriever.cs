...
namespace AAModClassic._Removed.Content.Parthenan.__Hardmode.NPCs.__BossRetriever
{
    ...
    public class Retriever : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            color = ColorUtils.MultiLerpColor(((int)(Main.GlobalTimeWrappedHourly * 60)) % 100 / 100f, drawColor, drawColor, Color.Violet, drawColor, Color.Violet, drawColor);
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            masterMode.OnSuccess(ItemDropRule.Common(ModContent.ItemType<RetrieverRelic>()));
