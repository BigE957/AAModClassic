...
namespace AAModClassic._Removed.Content.Parthenan.__Hardmode.Items.Tiles.Decoration.Ancient
{
    ...
    {
        public Color GlowColor => ColorUtils.MultiLerpColor(Main.LocalPlayer.miscCounter % 100 / 100f, Color.White, Color.White, Color.Violet, Color.White, Color.Violet, Color.White, Color.White, Color.White, Color.White, Color.Violet, Color.White, Color.Violet);
