    ...
    public class Genocide : ModProjectile
    {
        ...
        public override void AI()
        {
            for (int num447 = 0; num447 < 4; num447++)
            {
                ...
                int num448 = Dust.NewDust(vector33, Projectile.width, Projectile.height, ModContent.DustType<Dusts.VoidDust>(), 0f, 0f, 200, default, 1f); //Dust.NewDust(projectile.position, projectile.width, projectile.height, mod.DustType<Dusts.VoidDust>(), 0f, 0f, 200, default(Color), 1f);;
