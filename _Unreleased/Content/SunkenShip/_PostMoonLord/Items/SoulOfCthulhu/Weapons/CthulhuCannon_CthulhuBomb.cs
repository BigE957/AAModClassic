...
namespace AAModClassic._Unreleased.Projectiles.SoC
{
    public class CthulhuBomb : ModProjectile
	{
            ...
            if (Projectile.alpha > 0)
            {
                ...
                if (Projectile.alpha < 0)
                {
                    ...
                    while ((float)num110 < num109)
                    {
                        ...
                        int num111 = Dust.NewDust(Projectile.Center, 0, 0, ModContent.DustType<CthulhuDust>(), 0f, 0f, 0, default(Color), 1f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.penetrate = -1;
            Projectile.Damage();
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0, 0, Mod.Find<ModProjectile>("CthulhuBoom").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
            ...
            {
                int num88 = Dust.NewDust(position, num84, height3, ModContent.DustType<CthulhuDust>(), 0f, 0f, 200, default(Color), 3.7f);
                ...
                num88 = Dust.NewDust(position, num84, height3, ModContent.DustType<CthulhuDust>(), 0f, 0f, 100, default(Color), 1.5f);
                Main.dust[num88].position = Projectile.Center + (Vector2.UnitY.RotatedByRandom(3.1415927410125732) * (float)Main.rand.NextDouble() * (float)num84 / 2f);
            ...
            {
                int num90 = Dust.NewDust(position, num84, height3, ModContent.DustType<CthulhuDust>(), 0f, 0f, 0, default(Color), 2.7f);
