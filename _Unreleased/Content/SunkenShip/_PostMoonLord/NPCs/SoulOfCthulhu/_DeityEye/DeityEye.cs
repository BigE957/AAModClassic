        ...
        public override void AI()
        {
            ...
            if (NPC.ai[0] == 0f)
            {
                ...
                else if (NPC.ai[1] == 1f)
                {
                    ...
                    float num422 = Main.player[NPC.target].position.X + Main.player[NPC.target].width / 2 - vector41.X;
                    float num423 = Main.player[NPC.target].position.Y + Main.player[NPC.target].height / 2 - vector41.Y;
            ...
            else if (NPC.ai[0] == 1f || NPC.ai[0] == 2f)
            {
                ...
                if (NPC.ai[1] == 100f)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Dust.NewDust(NPC.position, NPC.width, NPC.height, ModContent.DustType<Dusts.CthulhuDust>(), Main.rand.Next(-30, 31) * 0.2f, Main.rand.Next(-30, 31) * 0.2f, 0, default, 1f);
                        }
            ...
            else
            {
                    ...
                    if (Collision.CanHit(NPC.position, NPC.width, NPC.height, Main.player[NPC.target].position, Main.player[NPC.target].width, Main.player[NPC.target].height))
                    {
                        ...
                        if (Main.netMode != NetmodeID.MultiplayerClient)
                        {
                            ...
                            if (NPC.localAI[1] > 8f)
                            {
                                ...
                                int num435 = ModContent.ProjectileType<DeityEye_DeityFlames>();
                                vector42 = new Vector2(NPC.position.X + NPC.width * 0.5f, NPC.position.Y + NPC.height * 0.5f);
                                num430 = Main.player[NPC.target].position.X + Main.player[NPC.target].width / 2 - vector42.X;
                                num431 = Main.player[NPC.target].position.Y + Main.player[NPC.target].height / 2 - vector42.Y;
                                num432 = (float)Math.Sqrt((double)(num430 * num430 + num431 * num431));
                                num432 = num433 / num432;
                                num430 *= num432;
                                num431 *= num432;
                                num431 += Main.rand.Next(-40, 41) * 0.01f;
                                num430 += Main.rand.Next(-40, 41) * 0.01f;
                ...
                else
                {
                    if (NPC.ai[1] == 1f)
                    {
                        ...
                        float num437 = Main.player[NPC.target].position.X + Main.player[NPC.target].width / 2 - vector43.X;
                        float num438 = Main.player[NPC.target].position.Y + Main.player[NPC.target].height / 2 - vector43.Y;
