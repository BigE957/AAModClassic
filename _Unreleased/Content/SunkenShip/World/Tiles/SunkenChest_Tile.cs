...
namespace AAModClassic._Unreleased.Content.SunkenShip.World.Tiles
{
    public class SunkenChest_Tile : ModTile
	{
		...
		{
			//Item.NewItem(i * 16, j * 16, 32, 32, ItemDrop/* tModPorter Note: _Unreleased. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */);
