...
public class BiomiteCore_HellfireBlast : ModProjectile
{
	...
	public override void AI()
	{
		...
		{
			int num = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Torch, 0f, 0f, 200, default, 0.5f);
	...
	public override void OnKill(int timeLeft)
	{
		for (int i = 0; i < 5; i++)
		{
			int num = Dust.NewDust(new Vector2(Projectile.Center.X, Projectile.Center.Y), Projectile.width, Projectile.height, DustID.Torch, (0f - Projectile.velocity.X) * 0.2f, (0f - Projectile.velocity.Y) * 0.2f, 100, default, 2f);
