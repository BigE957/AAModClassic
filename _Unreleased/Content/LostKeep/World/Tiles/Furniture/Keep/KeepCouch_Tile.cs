...
public class KeepCouch_Tile : ModTile
{
    ...
    {
        this.SetUpSofa(ModContent.ItemType<KeepCouch>());
        DustType = DustID.Stone;
    }

    public override void MouseOver(int i, int j) => FurnitureCommon.BenchMouseOver(i, j, ModContent.ItemType<KeepCouch>());
