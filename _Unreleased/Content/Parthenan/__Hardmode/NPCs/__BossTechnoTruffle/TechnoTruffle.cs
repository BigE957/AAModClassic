...
namespace AAModClassic._Unreleased.Content.Parthenan.__Hardmode.NPCs.__BossTechnoTruffle
{
    ...
    public class TechnoTruffle : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            //bossBag/* tModPorter Note: Removed. Spawn the treasure bag alongside other loot via npcLoot.Add(ItemDropRule.BossBag(type)) */ = Mod.Find<ModItem>("TruffleBag").Type;
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            {
                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center, NPC.velocity, ModContent.Find<ModProjectile>("TruffleBookIt").Type, 0, 0, 255, NPC.scale);
            }
        }
