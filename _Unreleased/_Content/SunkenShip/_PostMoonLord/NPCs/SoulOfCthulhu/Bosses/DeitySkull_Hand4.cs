    ...
    public class DeitySkull_Hand4 : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            for (int l = 0; l < 2; l++)
            {
                ...
                Main.spriteBatch.Draw(Mod.GetTexture("_Unreleased/NPCs/Bosses/SoC/Bosses/DeitySkull_Arm"), new Vector2(vector7.X - Main.screenPosition.X, vector7.Y - Main.screenPosition.Y), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(0, 0, ModContent.Request<Texture2D>("Terraria/Images/Arm_Bone").Value.Width, ModContent.Request<Texture2D>("Terraria/Images/Arm_Bone").Value.Height)), color7, rotation7, new Vector2((float)ModContent.Request<Texture2D>("Terraria/Images/Arm_Bone").Value.Width * 0.5f, (float)ModContent.Request<Texture2D>("Terraria/Images/Arm_Bone").Value.Height * 0.5f), 1f, SpriteEffects.None, 0f);
                if (l == 0)
                {
