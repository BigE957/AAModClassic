...
namespace AAModClassic.Base.BaseMod.Base
{
    ...
    public class TexGenData
    {
        ...
        public static TexGenData FromTexture2D(Texture2D texture)
        {
            ...
            Main.QueueMainThreadAction(() => texture.GetData(0, texture.Bounds, data, 0, texture.Width * texture.Height));
    ...
    public class TexGen
    {
        ...
        public static TexGenData GetTextureForGen(string path, bool useAsset = true)
        {
            ...
            {
                path = path.Replace("AAModClassic/", "") + ".rawimg";
                return TexGenData.FromStream(AAMod.instance.GetFileStream(path));
            }
        }
