...
{
    public class Lifeline_ForsakenArrow : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			target.buffImmune[ModContent.BuffType<Lifeline_ForsakenWeak>()] = false;
			target.AddBuff(ModContent.BuffType<Lifeline_ForsakenWeak>(), 300);
		}
