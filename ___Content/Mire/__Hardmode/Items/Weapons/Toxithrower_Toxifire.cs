...
namespace AAModClassic.___Content.Mire.__Hardmode.Items.Weapons
{
    public class Toxifire : ModProjectile
    {
        public override string Texture => "AAModClassic/BlankTex";
        public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Toxifire");
		}
        ...
        public override void AI()
        {
			...
			if (Projectile.ai[0] > 7f)
			{
				...
				Projectile.ai[0] += 1f;
				int num297 = ModContent.DustType<Dusts.HydratoxinDust>();
        ...
        {
        	target.AddBuff(ModContent.BuffType<HydraToxin_Buff>(), 240);
        }
    }
}