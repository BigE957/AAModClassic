...
using AAModClassic.___Content.Acropolis._PostMoonlord.Items._BossAthenaA.Accessories;
...
namespace AAModClassic.___Content.Acropolis._PostMoonlord.Items._BossAthenaA.BossStandard
{
    public class AthenaATreasureBag : BaseAAItem
    {
