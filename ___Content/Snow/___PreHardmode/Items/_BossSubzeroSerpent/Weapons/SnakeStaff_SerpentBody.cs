...
{
    public class SnakeStaff_SerpentBody : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (player.slotsMinions + Projectile.minionSlots > player.maxMinions && Projectile.owner == Main.myPlayer)
            {
                ...
                if (byUUID != -1)
                {
                    ...
                    if (projectile1.type != ModContent.ProjectileType<SnakeStaff_SerpentHead>()) projectile1.localAI[1] = Projectile.localAI[1];
