using AAModClassic.___Content._Tinker.___PreHardmode.Items.Accessories;
using Terraria;
using Terraria.ModLoader;

namespace AAModClassic.___Content.Snow.___PreHardmode.Items._BossSubzeroSerpent.Accessories
{
