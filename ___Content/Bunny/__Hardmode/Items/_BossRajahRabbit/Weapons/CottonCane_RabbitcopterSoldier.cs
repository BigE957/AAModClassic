...
{
    public class CottonCane_RabbitcopterSoldier : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<CottonCane_RabbitcopterSoldier>();
