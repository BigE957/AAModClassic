...
namespace AAModClassic.___Content.Bunny.__Hardmode.NPCs._Surface._Critter
{
    class RoyalRabbitCage : BaseAAItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<RoyalRabbitCage_Tile>(); //put your CustomBlock Tile name
        }
