using AAModClassic.___Content.Stars._PostMoonlord.Items._BossEquinoxWorms.Accessories;
...
Contained loot depends on the time of day"); */
            ...
            DaybringerTreasureBagTex = ModContent.Request<Texture2D>(Texture + "_Daybringer");
            DaybringerTreasureBagGlowmask = ModContent.Request<Texture2D>(Texture + "_Daybringer_Glow");
            NightcrawlerTreasureBagTex = ModContent.Request<Texture2D>(Texture + "_Nightcrawler");
            NightcrawlerTreasureBagGlowmask = ModContent.Request<Texture2D>(Texture + "_Nightcrawler_Glow");
