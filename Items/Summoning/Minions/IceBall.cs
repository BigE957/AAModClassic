    ...
    internal class IceBall : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			for (int num118 = 0; num118 < num117; num118++)
			{
				...
				int p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), vector2.X, vector2.Y, vector11.X*3f, vector11.Y*3f, ProjectileID.Blizzard, Projectile.damage, 8f, player.whoAmI);
