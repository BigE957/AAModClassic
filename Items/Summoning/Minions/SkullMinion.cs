...
namespace AAModClassic.Items.Summoning.Minions
{
    public class SkullMinion : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            player.AddBuff(Mod.Find<ModBuff>("SkullMinion").Type, 3600);
            if (player.dead)
            {
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                int num29 = ModContent.ProjectileType<SkullShot>();
                ...
                if (flag)
                {
                    ...
                    if (Projectile.ai[1] == 0f)
                    {
                        ...
                        if (Main.myPlayer == Projectile.owner)
                        {
                            ...
                            value4.Normalize();
                            value4 *= scaleFactor4;
                            int num33 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, value4.X, value4.Y, num29, Projectile.damage, 0f, Main.myPlayer, 0f, 0f);
