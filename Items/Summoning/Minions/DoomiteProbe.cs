...
namespace AAModClassic.Items.Summoning.Minions
{
    public class DoomiteProbe : ModProjectile
	{
        ...
        {
            bool flag64 = Projectile.type == ModContent.ProjectileType<DoomiteProbe>();
            Player player = Main.player[Projectile.owner];
            AAPlayer modPlayer = player.GetModPlayer<AAPlayer>();
            player.AddBuff(ModContent.BuffType<DoomiteProbe_Buff>(), 3600);
            if (flag64)
            {
                if (player.dead)
                {
            ...
            {
                bool flag23 = Main.projectile[num638].type == ModContent.ProjectileType<DoomiteProbe>();
