...
{
    public class DoomiteProbeC : ModProjectile
	{
        ...
        {
            bool flag64 = Projectile.type == Mod.Find<ModProjectile>("DoomiteProbeC").Type;
            Player player = Main.player[Projectile.owner];
            AAPlayer modPlayer = player.GetModPlayer<AAPlayer>();
            player.AddBuff(Mod.Find<ModBuff>("DoomiteProbeC").Type, 3600);
            if (flag64)
            {
                if (player.dead)
                {
                    modPlayer.DoomiteProbeC = false;
                }
            ...
            {
                bool flag23 = Main.projectile[num638].type == Mod.Find<ModProjectile>("DoomiteProbeC").Type;
