...
namespace AAModClassic.Items.Summoning
{
    public class HallowStaff : BaseAAItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 10f;
            Item.buffType = ModContent.BuffType<HallowedPrism>();
            Item.autoReuse = true;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(source, vector2.X, vector2.Y, num78, num79, ModContent.ProjectileType<HallowedPrism>(), num73, num74, i, 0f, 0f);
            return false;
        }
