...
namespace AAModClassic.Items.Dev.Minions
{
    public class SockPuppet : ModProjectile
    {
        ...
        {
            bool flag64 = Projectile.type == Mod.Find<ModProjectile>("SockPuppet").Type;
            Player player = Main.player[Projectile.owner];
            AAPlayer modPlayer = player.GetModPlayer<AAPlayer>();
            player.AddBuff(Mod.Find<ModBuff>("SockPuppet").Type, 3600);
            if (flag64)
            {
                if (player.dead)
                {
            ...
            {
                bool flag23 = Main.projectile[num638].type == Mod.Find<ModProjectile>("SockPuppet").Type;
