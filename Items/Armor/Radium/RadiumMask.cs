...
Shines with the light of a starry night sky"); */
		...
		public override void UpdateArmorSet(Player player)
		{
            ...
            player.setBonus = Language.GetTextValue("Mods.AAMod.Common.RadiumMaskBonus1") + (int)(100 * player.GetDamage(DamageClass.Magic)).Flat + " " + Language.GetTextValue("Mods.AAMod.Common.RadiumMaskBonus2") + player.GetCritChance(DamageClass.Magic) + Language.GetTextValue("Mods.AAMod.Common.RadiumMaskBonus3");
