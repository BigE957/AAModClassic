...
Reign of Fire EX"); */
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("AAModClassic/Glowmasks/ReignOfFire_Glow").Value;
            spriteBatch.Draw
            (
                texture,
                new Vector2
		...
		public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
		{
			if (Main.rand.NextBool(8))
			{
				...
				int p = Projectile.NewProjectile(Item.GetSource_ReleaseEntity(), vector2.X, vector2.Y, speedX5, speedY6, ModContent.ProjectileType<FireProjEX>(), Item.damage/2, Item.knockBack, Main.myPlayer);
