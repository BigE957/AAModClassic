...
Reign of Fire EX"); */
		...
		public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
		{
			if (Main.rand.NextBool(8))
			{
				...
				int p = Projectile.NewProjectile(Item.GetSource_ReleaseEntity(), vector2.X, vector2.Y, speedX5, speedY6, Mod.Find<ModProjectile>("FireProjEX").Type, Item.damage/2, Item.knockBack, Main.myPlayer);
