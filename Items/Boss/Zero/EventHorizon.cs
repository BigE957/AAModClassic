...
namespace AAModClassic.Items.Boss.Zero
{
    public class EventHorizon : BaseAAItem
	{
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Projectiles.Zero.EventHorizon_Proj>();
            Item.shootSpeed = 22f;
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
		{
            ...
            Projectile.NewProjectile(Item.GetSource_ReleaseEntity(), position.X, position.Y, baseSpeed * (float)Math.Sin(offsetAngle), baseSpeed * (float)Math.Cos(offsetAngle), ModContent.ProjectileType<Projectiles.Zero.EventHorizon_Proj>(), damage, knockback, player.whoAmI, 0.0f, ai3);
            return false;
        }
	}
}
