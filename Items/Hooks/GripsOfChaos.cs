	...
	internal class GripRed : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			while (distance > 30f && !float.IsNaN(distance)) 
			{
                ...
                //Draw chain
                Main.spriteBatch.Draw(ModContent.Request<Texture2D>("AAModClassic/Items/Hooks/GripRed_Chain").Value, new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
