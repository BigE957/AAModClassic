...
namespace AAMod.Items.Flasks
{
    public class GlowingSporeSac : BaseAAItem
	{
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            {
                Item.shoot = Mod.Find<ModProjectile>("GlowingSporeSac").Type;
                Item.shootSpeed = 9f;
            }
            else
            {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                Projectile.NewProjectile(position, new Microsoft.Xna.Framework.Vector2(speedX, speedY), type, 0, 0, Main.myPlayer, 3);
                return false;
            }
