...
namespace AAModClassic.Items.Ranged.Ammo
{
    public class OrderArrow : BaseAAItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<Projectiles.OrderArrow>();   //The projectile shoot when your weapon using this ammo
        ...
        public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<OrderBar>(), 2);
